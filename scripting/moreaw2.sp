...
new bool:m_bMarkVictim_ATTRIBUTE[2049];
new Float:m_flMarkVictim_Duration[2049]         = {0.0, ...};
new m_iMarkVictim_MaximumStack[2049]            = {0, ...};

new bool:m_bMarkVictimForDeath_ATTRIBUTE[2049];
new Float:m_flMarkVictimForDeath_Duration[2049] = {0.0, ...};
new m_iMarkVictimForDeath_MaximumStack[2049]    = {0, ...};

new bool:m_bDisableSlot_ATTRIBUTE[2049];
new Float:m_flDisableSlot_Duration[2049]        = {0.0, ...};
new m_iDisableSlot_Slot[2049]                   = {0, ...};

new bool:m_bDisarmSilent_ATTRIBUTE[2049];
new Float:m_flDisarmSilent_Duration[2049]       = {0.0, ...};

new bool:m_bSniperCombo_ATTRIBUTE[2049];
new Float:m_flSniperCombo_DMGA[2049]            = {0.0, ...};
new Float:m_flSniperCombo_DMGB[2049]            = {0.0, ...};
new Float:m_flSniperCombo_DMGC[2049]            = {0.0, ...};

new bool:m_bIncreasedPushScale_ATTRIBUTE[2049];
new Float:m_flIncreasedPushScale_Scale[2049]    = {0.0, ...};

new bool:m_bMissCauseDelay_ATTRIBUTE[2049];
new Float:m_flMissCauseDelay_Delay[2049]        = {0.0, ...};

new bool:m_bCritHealingMedic_ATTRIBUTE[2049];

new bool:m_bDemoChargeOnHit_ATTRIBUTE[2049];
new Float:m_flDemoChargeOnHit_Charge[2049]      = {0.0, ...};

new bool:m_bPyroCombo_ATTRIBUTE[2049];
new Float:m_flPyroCombo_DMGA[2049]              = {0.0, ...};
new Float:m_flPyroCombo_DMGB[2049]              = {0.0, ...};
new Float:m_flPyroCombo_DMGC[2049]              = {0.0, ...};

new bool:m_bPissYourselfOnMiss_ATTRIBUTE[2049];


    /* On Crit
     * ---------------------------------------------------------------------- */

new bool:m_bMiniCritDisguisedCLOSERANGE_ATTRIBUTE[2049];
new Float:m_flMiniCritDisguisedCLOSERANGE_Range[2049]                   = {0.0, ...};

new bool:m_bCritDisguisedCLOSERANGE_ATTRIBUTE[2049];
new Float:m_flCritDisguisedCLOSERANGE_Range[2049]                       = {0.0, ...};


    /* On Kill
     * ---------------------------------------------------------------------- */

new bool:m_bUberchargeOnKill_ATTRIBUTE[2049];
new Float:m_flUberchargeOnKill_Amount[2049] = {0.0, ...};


    /* On Damage
     * ---------------------------------------------------------------------- */

new bool:m_bUberchargeToDamage_ATTRIBUTE[2049];
new Float:m_flUberchargeToDamage_Multiplier[2049]                       = {0.0, ...};

new bool:m_bEnemyUberchargeToDamage_ATTRIBUTE[2049];
new Float:m_flEnemyUberchargeToDamage_Multiplier[2049]                  = {0.0, ...};

new bool:m_bExplosiveDamage_ATTRIBUTE[2049];
new Float:m_flExplosiveDamage_Damage[2049]                              = {0.0, ...};
new Float:m_flExplosiveDamage_Force[2049]                               = {0.0, ...};
new Float:m_flExplosiveDamage_Radius[2049]                              = {0.0, ...};
new m_iExplosiveDamage_DamageMode[2049]                                 = {0, ...};

new bool:m_bExplosiveCriticalDamage_ATTRIBUTE[2049];
new Float:m_flExplosiveCriticalDamage_Damage[2049]                      = {0.0, ...};
new Float:m_flExplosiveCriticalDamage_Force[2049]                       = {0.0, ...};
new Float:m_flExplosiveCriticalDamage_Radius[2049]                      = {0.0, ...};
new m_iExplosiveCriticalDamage_DamageMode[2049]                         = {0, ...};

new bool:m_bLevelUpSystem_DamageDone_ATTRIBUTE[2049];
new Float:m_flLevelUpSystem_DamageDone_BonusDamage[2049]                = {0.0, ...};
new Float:m_flLevelUpSystem_DamageDone_Charge[2049]                     = {0.0, ...};
new Float:m_flLevelUpSystem_DamageDone_CriticalChance[2049]             = {0.0, ...};
new Float:m_flLevelUpSystem_DamageDone_Lifesteal[2049]                  = {0.0, ...};
new Float:m_flLevelUpSystem_DamageDone_PocketUberchargeDuration[2049]   = {0.0, ...};

new bool:m_bNonCriticalDamageModifier_ATTRIBUTE[2049];
new Float:m_flNonCriticalDamageModifier_Multiplier[2049]                = {0.0, ...};

new bool:m_bFlyWhileShooting_ATTRIBUTE[2049];

new bool:m_bDisorientateOnHit_ATTRIBUTE[2049];

new bool:m_bNoBackstab_ATTRIBUTE[2049];
new Float:m_flNoBackstab_Damage[2049]                                   = {0.0, ...};

new bool:m_bElectroshock_ATTRIBUTE[2049];
new Float:m_flElectroshock_Charge[2049]                                 = {0.0, ...};
new Float:m_flElectroshock_Duration[2049]                               = {0.0, ...};


    /* On Prethink
     * ---------------------------------------------------------------------- */

new bool:m_bSpeedCloak_ATTRIBUTE[2049];
new Float:m_flSpeedCloak_Amount[2049]                       = {0.0, ...};

new bool:m_bDemoCharge_Ubercharge_ATTRIBUTE[2049];

new bool:m_bDemoCharge_Invisibility_ATTRIBUTE[2049];

new bool:m_bCritOnHealthPointsThreshold_ATTRIBUTE[2049];
new Float:m_flCritOnHealthPointsThreshold_Threshold[2049]   = {0.0, ...};

new bool:m_bSpeedBoostFire_ATTRIBUTE[2049];

new bool:m_bRageDecrease_ATTRIBUTE[2049];
new Float:m_flRageDecrease_Amount[2049]                     = {0.0, ...};

new bool:m_bDisableAlt_ATTRIBUTE[2049];

new bool:m_bDisablePrimAlt_ATTRIBUTE[2049];

new bool:m_bJumpBonus_ATTRIBUTE[2049];
new m_iJumpBonus_BaseJumps[2049]                            = {0, ...};
new m_iJumpBonus_Hit[2049]                                  = {0, ...};
new m_iJumpBonus_Kill[2049]                                 = {0, ...};
new m_iJumpBonus_MaxJumps[2049]                             = {0, ...};
new m_iDashOffSet;

new bool:m_bChargedAirblast_SOUNDONLY_ATTRIBUTE[2049];


    /* On Damage Received
     * ---------------------------------------------------------------------- */

new bool:m_bLevelUpSystem_DamageReceived_ATTRIBUTE[2049];
new Float:m_flLevelUpSystem_DamageReceived_AttackSpeed[2049]                = {0.0, ...};
new Float:m_flLevelUpSystem_DamageReceived_Charge[2049]                     = {0.0, ...};
new Float:m_flLevelUpSystem_DamageReceived_CriticalDamageResistance[2049]   = {0.0, ...};
new Float:m_flLevelUpSystem_DamageReceived_HealthRegeneration[2049]         = {0.0, ...};
new Float:m_flLevelUpSystem_DamageReceived_Lifesteal[2049]                  = {0.0, ...};
new Float:m_flLevelUpSystem_DamageReceived_OldAttackSpeed[2049]             = {0.0, ...};
new Float:m_flLevelUpSystem_DamageReceived_OldHealthRegeneration[2049]      = {0.0, ...};

new bool:m_bMetalShield_ATTRIBUTE[2049];
new Float:m_flMetalShield_DamageAbsorb[2049]                                = {0.0, ...};
new Float:m_flMetalShield_DamageAbsorbMetalPct[2049]                        = {0.0, ...};


    /* To Activate
     * ---------------------------------------------------------------------- */

new bool:m_bAddCondAltFire_ATTRIBUTE[2049];
new Float:m_flAddCondAltFire_Duration[2049]     = {0.0, ...};
new Float:m_flAddCondAltFire_HealthPoints[2049] = {0.0, ...};
new m_iAddCondAltFire_ID[2049]                  = {0, ...};

new bool:m_bMiniMann_ATTRIBUTE[2049];
new Float:m_flMiniMann_Cooldown[2049]           = {0.0, ...};
new Float:m_flMiniMann_Duration[2049]           = {0.0, ...};
new Float:m_flMiniMann_Resize[2049]             = {0.0, ...};
new m_iMiniMann_Speed[2049]                     = {0, ...};
new m_iMiniMann_Type[2049]                      = {0, ...};

new bool:m_bDeployUbercharge_ATTRIBUTE[2049];
new Float:m_flDeployUbercharge_Threshold[2049]  = {0.0, ...};

new bool:m_bBonkHealth_ATTRIBUTE[2049];
new Float:m_flBonkHealth_Cooldown[2049]         = {0.0, ...};
new Float:m_flBonkHealth_Heal[2049]             = {0.0, ...};
new Float:m_flBonkHealth_OverHealBonusCap[2049] = {0.0, ...};


    /* On Death
     * ---------------------------------------------------------------------- */

new bool:m_bRespawnWhereYouDied_ATTRIBUTE[2049];
new Float:m_flRespawnWhereYouDied_Charge[2049]  = {0.0, ...};
new Float:m_flRespawnWhereYouDied_Delay[2049]   = {0.0, ...};
...
ATTRIBUTE_DAMAGERECEIVED( m_iClient, &m_iButtons, &m_iSlot, &m_iButtonsLast )
{
    if ( HasAttribute( m_iClient, _, m_bLevelUpSystem_DamageReceived_ATTRIBUTE, true ) )
    {
        ...
        {
            if ( !( TF2Attrib_GetByName( m_iWeapon, "fire rate bonus" ) ) ) TF2Attrib_SetByName( m_iWeapon, "fire rate bonus", GetAttributeValue( m_iClient, _, m_bLevelUpSystem_DamageReceived_ATTRIBUTE, m_flLevelUpSystem_DamageReceived_OldAttackSpeed, true ) );
            ...
            new Float:fValue = GetAttributeValue( m_iClient, _, m_bLevelUpSystem_DamageReceived_ATTRIBUTE, m_flLevelUpSystem_DamageReceived_AttackSpeed, true );
        ...
        {
            if ( !( TF2Attrib_GetByName( m_iWeapon, "health regen" ) ) ) TF2Attrib_SetByName( m_iWeapon, "health regen", GetAttributeValue( m_iClient, _, m_bLevelUpSystem_DamageReceived_ATTRIBUTE, m_flLevelUpSystem_DamageReceived_OldHealthRegeneration, true ) );
            TF2Attrib_SetByName( m_iWeapon, "health regen", GetAttributeValue( m_iClient, _, m_bLevelUpSystem_DamageReceived_ATTRIBUTE, m_flLevelUpSystem_DamageReceived_HealthRegeneration, true ) );
...
ATTRIBUTE_ADDCONDALT( m_iClient, &m_iButtons, &m_iSlot, &m_iButtonsLast )
{
    if ( HasAttribute( m_iClient, _, m_bAddCondAltFire_ATTRIBUTE, true ) && m_iButtons & IN_ATTACK2 == IN_ATTACK2 )
    {
        ...
        if ( !TF2_IsPlayerInCondition( m_iClient, TFCond:GetAttributeValue( m_iClient, _, m_bAddCondAltFire_ATTRIBUTE, m_iAddCondAltFire_ID, true ) ) )
        {
            if ( GetAttributeValue( m_iClient, _, m_bAddCondAltFire_ATTRIBUTE, m_flAddCondAltFire_HealthPoints, true ) >= 1.0 )
            {
                if ( GetClientHealth( m_iClient ) > GetAttributeValue( m_iClient, _, m_bAddCondAltFire_ATTRIBUTE, m_flAddCondAltFire_HealthPoints, true ) )
                {
                    DealDamage( m_iClient, RoundToFloor( GetAttributeValue( m_iClient, _, m_bAddCondAltFire_ATTRIBUTE, m_flAddCondAltFire_HealthPoints, true ) ), m_iClient, TF_DMG_PREVENT_PHYSICS_FORCE );

                    TF2_AddCondition( m_iClient, TFCond:GetAttributeValue( m_iClient, _, m_bAddCondAltFire_ATTRIBUTE, m_iAddCondAltFire_ID, true ), GetAttributeValue( m_iClient, _, m_bAddCondAltFire_ATTRIBUTE, m_flAddCondAltFire_Duration, true ) );
                    EmitSoundToClient( m_iClient, SOUND_READY );
                }
            } else {
                if ( GetClientHealth( m_iClient ) > TF2_GetClientMaxHealth( m_iClient ) * GetAttributeValue( m_iClient, _, m_bAddCondAltFire_ATTRIBUTE, m_flAddCondAltFire_HealthPoints, true ) )
                {
                    DealDamage( m_iClient, TF2_GetClientMaxHealth( m_iClient ) * GetAttributeValue( m_iClient, _, m_bAddCondAltFire_ATTRIBUTE, m_flAddCondAltFire_HealthPoints, true )+0, m_iClient, TF_DMG_PREVENT_PHYSICS_FORCE );
...
ATTRIBUTE_DEPLOYUBERCHARGE( m_iClient, &m_iButtons, &m_iSlot, &m_iButtonsLast )
{
    if ( HasAttribute( m_iClient, _, m_bDeployUbercharge_ATTRIBUTE ) )
    {
        if ( HasAttribute( m_iClient, _, m_bDeployUbercharge_ATTRIBUTE, true ) && m_iButtons & IN_ATTACK2 == IN_ATTACK2 ) {
            ...
            {
                new Float:Threshold = GetAttributeValue( m_iClient, _, m_bDeployUbercharge_ATTRIBUTE, m_flDeployUbercharge_Threshold, true );
    ...
    if ( HasAttribute( m_iClient, _, m_bLevelUpSystem_DamageDone_ATTRIBUTE ) )
    {
        if ( HasAttribute( m_iClient, _, m_bLevelUpSystem_DamageDone_ATTRIBUTE, true ) )
        {
            if ( m_iButtons & IN_ATTACK2 == IN_ATTACK2 ) {
                ...
                if ( !TF2_IsPlayerInCondition( m_iClient, TFCond_Ubercharged ) && m_hTimers[m_iClient][m_hDamageDone_TimerDuration] == INVALID_HANDLE && m_flFloats[m_iClient][m_flDamageCharge] >= 400.0 )
                {
                    m_hTimers[m_iClient][m_hDamageDone_TimerDuration] = CreateTimer( GetAttributeValue( m_iClient, _, m_bLevelUpSystem_DamageDone_ATTRIBUTE, m_flLevelUpSystem_DamageDone_PocketUberchargeDuration, true ), m_tDamageDone_TimerDuration, m_iClient );
                    TF2_AddCondition( m_iClient, TFCond_Ubercharged, GetAttributeValue( m_iClient, _, m_bLevelUpSystem_DamageDone_ATTRIBUTE, m_flLevelUpSystem_DamageDone_PocketUberchargeDuration, true ) );
                    TF2_AddCondition( m_iClient, TFCond_TeleportedGlow, GetAttributeValue( m_iClient, _, m_bLevelUpSystem_DamageDone_ATTRIBUTE, m_flLevelUpSystem_DamageDone_PocketUberchargeDuration, true ) );
                    EmitSoundToClient( m_iClient, SOUND_UBER );
                }
            }
        }
        if ( m_hTimers[m_iClient][m_hDamageDone_TimerDuration] != INVALID_HANDLE ) {
            m_flFloats[m_iClient][m_flDamageCharge] -= ( 0.75 / GetAttributeValue( m_iClient, _, m_bLevelUpSystem_DamageDone_ATTRIBUTE, m_flLevelUpSystem_DamageDone_PocketUberchargeDuration ) );
    ...
    if ( HasAttribute( m_iClient, _, m_bMiniMann_ATTRIBUTE ) )
    {
        ...
        {    
            if ( m_hTimers[m_iClient][m_hMiniMann_TimerCooldown] == INVALID_HANDLE && m_hTimers[m_iClient][m_hMiniMann_TimerDelay] == INVALID_HANDLE && GetEntityFlags( m_iClient ) & FL_ONGROUND )
            {
                ...
                m_hTimers[m_iClient][m_hMiniMann_TimerCooldown] = CreateTimer( GetAttributeValue( m_iClient, _, m_bMiniMann_ATTRIBUTE, m_flMiniMann_Cooldown, true )+1.2, m_tMiniMann_Cooldown, m_iClient );
                if ( m_hTimers[m_iClient][m_hMiniMann_TimerDuration] != INVALID_HANDLE ) ClearTimer( m_hTimers[m_iClient][m_hMiniMann_TimerDuration] );
                else m_hTimers[m_iClient][m_hMiniMann_TimerDuration] = CreateTimer( GetAttributeValue( m_iClient, _, m_bMiniMann_ATTRIBUTE, m_flMiniMann_Duration, true )+1.2, m_tMiniMann_Duration, m_iClient );
            }
        }
    ...
    if ( HasAttribute( m_iClient, _, m_bBonkHealth_ATTRIBUTE ) )
    {
        ...
        {    
            if ( m_hTimers[m_iClient][m_hBonkHealth_TimerCooldown] == INVALID_HANDLE && m_hTimers[m_iClient][m_hBonkHealth_TimerDelay] == INVALID_HANDLE && GetEntityFlags( m_iClient ) & FL_ONGROUND )
            {
                ...
                m_hTimers[m_iClient][m_hBonkHealth_TimerCooldown] = CreateTimer( GetAttributeValue( m_iClient, _, m_bBonkHealth_ATTRIBUTE, m_flBonkHealth_Cooldown, true )+1.2, m_tBonkHealth, m_iClient );
            }
        }
...
ATTRIBUTE_SPEEDCLOAK( m_iClient, &m_iButtons, &m_iSlot, &m_iButtonsLast )
{
    if ( HasAttribute( m_iClient, _, m_bSpeedCloak_ATTRIBUTE ) )
    {
        ...
        if ( TF2_IsPlayerInCondition( m_iClient, TFCond_Cloaked ) )
        {
            if ( m_flSpeed > 5.0 )
            {
                new Float:m_flNewSpeed = GetAttributeValue( m_iClient, _, m_bSpeedCloak_ATTRIBUTE, m_flSpeedCloak_Amount );
...
ATTRIBUTE_RAGEDRAIN( m_iClient, &m_iButtons, &m_iSlot, &m_iButtonsLast )
{
    if ( HasAttribute( m_iClient, _, m_bRageDecrease_ATTRIBUTE ) ) {
        if ( m_hTimers[m_iClient][m_hRageDecrease_TimerDelay] == INVALID_HANDLE && m_bBools[m_iClient][m_bDrainRage] )
        {
            ...
            if ( m_flRage > 0.0 ) SetEntPropFloat( m_iClient, Prop_Send, "m_flRageMeter", m_flRage - GetAttributeValue( m_iClient, _, m_bRageDecrease_ATTRIBUTE, m_flRageDecrease_Amount ) );
        }
    }
...
ATTRIBUTE_ELECTROSHOCK( m_iClient, &m_iButtons, &m_iSlot, &m_iButtonsLast )
{
    if ( HasAttribute( m_iClient, _, m_bElectroshock_ATTRIBUTE ) ) {
        if ( m_flFloats[m_iClient][m_flElectroshockEngine] >= GetEngineTime() - GetAttributeValue( m_iClient, _, m_bElectroshock_ATTRIBUTE, m_flElectroshock_Duration ) )
        {
...
ATTRIBUTE_JUMPBONUS( m_iClient, &m_iButtons, &m_iSlot, &m_iButtonsLast )
{
    if ( HasAttribute( m_iClient, _, m_bJumpBonus_ATTRIBUTE ) ) {
        ...
        if ( m_iIntegers[m_iClient][m_iJumpAmount] > GetAttributeValue( m_iClient, _, m_bJumpBonus_ATTRIBUTE, m_iJumpBonus_MaxJumps ) ) m_iIntegers[m_iClient][m_iJumpAmount] = GetAttributeValue( m_iClient, _, m_bJumpBonus_ATTRIBUTE, m_iJumpBonus_MaxJumps );
        if ( m_iIntegers[m_iClient][m_iJumpAmountBase] < 0 ) m_iIntegers[m_iClient][m_iJumpAmountBase] = 0;
        if ( m_iIntegers[m_iClient][m_iJumpAmountBase] > GetAttributeValue( m_iClient, _, m_bJumpBonus_ATTRIBUTE, m_iJumpBonus_BaseJumps ) ) m_iIntegers[m_iClient][m_iJumpAmountBase] = GetAttributeValue( m_iClient, _, m_bJumpBonus_ATTRIBUTE, m_iJumpBonus_BaseJumps );

        if ( GetEntityFlags( m_iClient ) & FL_ONGROUND ) m_iIntegers[m_iClient][m_iJumpAmountBase] = GetAttributeValue( m_iClient, _, m_bJumpBonus_ATTRIBUTE, m_iJumpBonus_BaseJumps );
        ...
        {
            if ( ( m_iIntegers[m_iClient][m_iJumpAmount] <= GetAttributeValue( m_iClient, _, m_bJumpBonus_ATTRIBUTE, m_iJumpBonus_MaxJumps ) ) && ( m_iIntegers[m_iClient][m_iJumpAmount] > -1 ) && ( m_iIntegers[m_iClient][m_iJumpAmountBase] <= 0 ) )
            {
            ...
            else if ( ( m_iIntegers[m_iClient][m_iJumpAmountBase] <= GetAttributeValue( m_iClient, _, m_bJumpBonus_ATTRIBUTE, m_iJumpBonus_BaseJumps ) ) && ( m_iIntegers[m_iClient][m_iJumpAmountBase] > 0 ) )
            {
        ...
        if ( GetAttributeValue( m_iClient, _, m_bJumpBonus_ATTRIBUTE, m_iJumpBonus_BaseJumps ) == 1 && !( bIsInJump[m_iClient] ) ) SetEntData( m_iClient, m_iDashOffSet, 1 );
...
HUD_SHOWSYNCHUDTEXT( m_iClient, &m_iButtons, &m_iSlot, &m_iButtonsLast )
{
    ...
    if ( HasAttribute( m_iClient, _, m_bLevelUpSystem_DamageReceived_ATTRIBUTE ) ) {
        ...
        if ( HasAttribute( m_iClient, _, m_bLevelUpSystem_DamageReceived_ATTRIBUTE, true ) )
        {
            ...
            if ( m_flFloats[m_iClient][m_flTakeDamageCharge] < 200.0 ) TF2Attrib_SetByName( m_iWeapon, "fire rate bonus", GetAttributeValue( m_iClient, _, m_bLevelUpSystem_DamageReceived_ATTRIBUTE, m_flLevelUpSystem_DamageReceived_OldAttackSpeed, true ) );
            if ( m_flFloats[m_iClient][m_flTakeDamageCharge] >= 200.0 ) TF2Attrib_SetByName( m_iWeapon, "fire rate bonus", GetAttributeValue( m_iClient, _, m_bLevelUpSystem_DamageReceived_ATTRIBUTE, m_flLevelUpSystem_DamageReceived_AttackSpeed, true ) );
            if ( m_flFloats[m_iClient][m_flTakeDamageCharge] < 300.0 ) TF2Attrib_SetByName( m_iWeapon, "health regen", GetAttributeValue( m_iClient, _, m_bLevelUpSystem_DamageReceived_ATTRIBUTE, m_flLevelUpSystem_DamageReceived_OldHealthRegeneration, true ) );
            if ( m_flFloats[m_iClient][m_flTakeDamageCharge] >= 300.0 ) TF2Attrib_SetByName( m_iWeapon, "health regen", GetAttributeValue( m_iClient, _, m_bLevelUpSystem_DamageReceived_ATTRIBUTE, m_flLevelUpSystem_DamageReceived_HealthRegeneration, true ) );
        }
    }
//-//
    if ( HasAttribute( m_iClient, _, m_bLevelUpSystem_DamageDone_ATTRIBUTE ) ) {
...
//-//
    if ( HasAttribute( m_iClient, _, m_bJumpBonus_ATTRIBUTE ) )
    {
        ...
        new BaseJumps = GetAttributeValue( m_iClient, _, m_bJumpBonus_ATTRIBUTE, m_iJumpBonus_BaseJumps );
        new Jumps;
        if ( m_iIntegers[m_iClient][m_iJumpAmount]-( BaseJumps == 1 ? 1 : 0 ) < 1 ) Jumps = 0;
        else Jumps = m_iIntegers[m_iClient][m_iJumpAmount]-( BaseJumps == 1 ? 1 : 0 );
        /* ** ! ** */
        if ( GetAttributeValue( m_iClient, _, m_bJumpBonus_ATTRIBUTE, m_iJumpBonus_MaxJumps ) >= 1024 ) {
            Format( m_strHUDJumpBonus, sizeof( m_strHUDJumpBonus ), "Jumps %i", Jumps );
        } else {
            Format( m_strHUDJumpBonus, sizeof( m_strHUDJumpBonus ), "Jumps %i/%i", Jumps, GetAttributeValue( m_iClient, _, m_bJumpBonus_ATTRIBUTE, m_iJumpBonus_MaxJumps )-( BaseJumps == 1 ? 1 : 0 ) );
        }
    }
//-//
...
public Action:CustomWeaponsTF_OnAddAttribute( m_iWeapon, m_iClient, const String:m_sAttribute[], const String:m_sPlugin[], const String:m_sValue[] )
{
    ...
    {
        m_flUberchargeToDamage_Multiplier[m_iWeapon]    = StringToFloat( m_sValue );
        m_bUberchargeToDamage_ATTRIBUTE[m_iWeapon]      = true;
    ...
    {
        m_flEnemyUberchargeToDamage_Multiplier[m_iWeapon]   = StringToFloat( m_sValue );
        m_bEnemyUberchargeToDamage_ATTRIBUTE[m_iWeapon]     = true;
        m_aAction = Plugin_Handled;
    }
    ...
    {
        m_flSpeedCloak_Amount[m_iWeapon]            = StringToFloat( m_sValue );
        m_bSpeedCloak_ATTRIBUTE[m_iWeapon]          = true;
        m_aAction = Plugin_Handled;
    }
    ...
    {
        m_bDemoCharge_Invisibility_ATTRIBUTE[m_iWeapon]     = true;
        m_aAction = Plugin_Handled;
    }
    ...
    {
        m_bDemoCharge_Ubercharge_ATTRIBUTE[m_iWeapon]       = true;
        m_aAction = Plugin_Handled;
    }
    /* Mark Victim
     *
    ...
    else if ( StrEqual( m_sAttribute, "mark victim" ) )
    {
        ...
        m_iMarkVictim_MaximumStack[m_iWeapon]       = StringToInt( m_sValues[0] );
        m_flMarkVictim_Duration[m_iWeapon]          = StringToFloat( m_sValues[1] );
        m_bMarkVictim_ATTRIBUTE[m_iWeapon]          = true;
        m_aAction = Plugin_Handled;
    }
    ...
    else if ( StrEqual( m_sAttribute, "mark victim fd" ) )
    {
        ...
        m_iMarkVictimForDeath_MaximumStack[m_iWeapon]   = StringToInt( m_sValues[0] );
        m_flMarkVictimForDeath_Duration[m_iWeapon]      = StringToFloat( m_sValues[1] );
        m_bMarkVictimForDeath_ATTRIBUTE[m_iWeapon]      = true;
        m_aAction = Plugin_Handled;
    }
    /* Damage Is Explosive
     *
    ...
    else if ( StrEqual( m_sAttribute, "dmg is explosive" ) )
    {
        ...
        m_flExplosiveDamage_Force[m_iWeapon]        = StringToFloat( m_sValues[0] );
        m_flExplosiveDamage_Radius[m_iWeapon]       = StringToFloat( m_sValues[1] );
        m_flExplosiveDamage_Damage[m_iWeapon]       = StringToFloat( m_sValues[2] );
        m_iExplosiveDamage_DamageMode[m_iWeapon]   = StringToInt( m_sValues[3] );
        m_bExplosiveDamage_ATTRIBUTE[m_iWeapon]     = true;
        m_aAction = Plugin_Handled;
    }
    ...
    else if ( StrEqual( m_sAttribute, "crit dmg is explosive" ) )
    {
        ...
        m_flExplosiveCriticalDamage_Force[m_iWeapon]        = StringToFloat( m_sValues[0] );
        m_flExplosiveCriticalDamage_Radius[m_iWeapon]       = StringToFloat( m_sValues[1] );
        m_flExplosiveCriticalDamage_Damage[m_iWeapon]       = StringToFloat( m_sValues[2] );
        m_iExplosiveCriticalDamage_DamageMode[m_iWeapon]   = StringToInt( m_sValues[3] );
        m_bExplosiveCriticalDamage_ATTRIBUTE[m_iWeapon]     = true;
        m_aAction = Plugin_Handled;
    }
    /* Übercharge On Kill
     *
    ...
    {
        m_flUberchargeOnKill_Amount[m_iWeapon]      = StringToFloat( m_sValue );
        m_bUberchargeOnKill_ATTRIBUTE[m_iWeapon]    = true;
        m_aAction = Plugin_Handled;
    }
    ...
    else if ( StrEqual( m_sAttribute, "addcond altfire" ) )
    {
        ...
        m_flAddCondAltFire_HealthPoints[m_iWeapon]  = StringToFloat( m_sValues[0] );
        m_iAddCondAltFire_ID[m_iWeapon]             = StringToInt( m_sValues[1] );
        m_flAddCondAltFire_Duration[m_iWeapon]      = StringToFloat( m_sValues[2] );
        m_bAddCondAltFire_ATTRIBUTE[m_iWeapon]      = true;
        m_aAction = Plugin_Handled;
    }
    /* Deploy Übercharge
     *
    ...
    {
        m_flDeployUbercharge_Threshold[m_iWeapon]   = StringToFloat( m_sValue );
        m_bDeployUbercharge_ATTRIBUTE[m_iWeapon]    = true;
        m_aAction = Plugin_Handled;
    }
    ...
    else if ( StrEqual( m_sAttribute, "weapon lvlup" ) )
    {
        ...
        m_flLevelUpSystem_DamageDone_Charge[m_iWeapon]                      = StringToFloat( m_sValues[0] ); // charge
        m_flLevelUpSystem_DamageDone_Lifesteal[m_iWeapon]                   = StringToFloat( m_sValues[1] ); // 1
        m_flLevelUpSystem_DamageDone_BonusDamage[m_iWeapon]                 = StringToFloat( m_sValues[2] ); // 2
        m_flLevelUpSystem_DamageDone_CriticalChance[m_iWeapon]              = StringToFloat( m_sValues[3] ); // 3
        m_flLevelUpSystem_DamageDone_PocketUberchargeDuration[m_iWeapon]    = StringToFloat( m_sValues[4] ); // 4
        m_bLevelUpSystem_DamageDone_ATTRIBUTE[m_iWeapon] = true;
        m_aAction = Plugin_Handled;
    }
    ...
    else if ( StrEqual( m_sAttribute, "weapon lvlup 2" ) )
    {
        ...
        m_flLevelUpSystem_DamageReceived_Charge[m_iWeapon]                      = StringToFloat( m_sValues[0] ); // charge
        m_flLevelUpSystem_DamageReceived_Lifesteal[m_iWeapon]                   = StringToFloat( m_sValues[1] ); // 1
        m_flLevelUpSystem_DamageReceived_AttackSpeed[m_iWeapon]                 = StringToFloat( m_sValues[2] ); // 2
        m_flLevelUpSystem_DamageReceived_OldAttackSpeed[m_iWeapon]              = StringToFloat( m_sValues[3] ); // -
        m_flLevelUpSystem_DamageReceived_HealthRegeneration[m_iWeapon]          = StringToFloat( m_sValues[4] ); // 3
        m_flLevelUpSystem_DamageReceived_OldHealthRegeneration[m_iWeapon]       = StringToFloat( m_sValues[5] ); // -
        m_flLevelUpSystem_DamageReceived_CriticalDamageResistance[m_iWeapon]    = StringToFloat( m_sValues[6] ); // 4
        m_bLevelUpSystem_DamageReceived_ATTRIBUTE[m_iWeapon] = true;
        m_aAction = Plugin_Handled;
    }
    ...
    else if ( StrEqual( m_sAttribute, "respawn where you died" ) )
    {
        ...
        m_flRespawnWhereYouDied_Charge[m_iWeapon]   = StringToFloat( m_sValues[0] );
        m_flRespawnWhereYouDied_Delay[m_iWeapon]    = StringToFloat( m_sValues[1] );
        m_bRespawnWhereYouDied_ATTRIBUTE[m_iWeapon] = true;
        m_aAction = Plugin_Handled;
    }
    /* Fly While Shooting
     *
    ...
    {
        m_bFlyWhileShooting_ATTRIBUTE[m_iWeapon]    = true;
        m_aAction = Plugin_Handled;
    }
    /* Mini Mann
     *
    ...
    else if ( StrEqual( m_sAttribute, "minimann attr" ) )
    {
        ...
        m_flMiniMann_Resize[m_iWeapon]              = StringToFloat( m_sValues[0] );
        m_flMiniMann_Duration[m_iWeapon]            = StringToFloat( m_sValues[1] );
        m_flMiniMann_Cooldown[m_iWeapon]            = StringToFloat( m_sValues[2] );
        m_iMiniMann_Type[m_iWeapon]                 = StringToInt( m_sValues[3] );
        m_iMiniMann_Speed[m_iWeapon]                = StringToInt( m_sValues[4] );
        m_bMiniMann_ATTRIBUTE[m_iWeapon]            = true;
        m_aAction = Plugin_Handled;
    }
    /* Disable Dlot
     *
    ...
    else if ( StrEqual( m_sAttribute, "disable slot" ) )
    {
        ...
        m_iDisableSlot_Slot[m_iWeapon]              = StringToInt( m_sValues[0] );
        m_flDisableSlot_Duration[m_iWeapon]         = StringToFloat( m_sValues[1] );
        m_bDisableSlot_ATTRIBUTE[m_iWeapon]         = true;
        m_aAction = Plugin_Handled;
    }
    /* Disable Alt-Fire
     *
    ...
    {
        m_bDisableAlt_ATTRIBUTE[m_iWeapon]          = true;
        m_aAction = Plugin_Handled;
    }
    ...
    else if ( StrEqual( m_sAttribute, "jump bonus on hitkill" ) )
    {
        ...
        m_iJumpBonus_Hit[m_iWeapon]         = StringToInt( m_sValues[0] );
        m_iJumpBonus_Kill[m_iWeapon]        = StringToInt( m_sValues[1] );
        m_iJumpBonus_MaxJumps[m_iWeapon]    = StringToInt( m_sValues[2] );
        m_iJumpBonus_BaseJumps[m_iWeapon]   = StringToInt( m_sValues[3] );
        ...
        if ( m_iJumpBonus_BaseJumps[m_iWeapon] == 1 ) m_iJumpBonus_MaxJumps[m_iWeapon]++;
        /* ** ! ** */
        m_bJumpBonus_ATTRIBUTE[m_iWeapon]   = true;
        m_aAction = Plugin_Handled;
    }
    /* Bonk Health
     *
    ...
    else if ( StrEqual( m_sAttribute, "bonk health" ) )
    {
        ...
        m_flBonkHealth_Heal[m_iWeapon]              = StringToFloat( m_sValues[0] );
        m_flBonkHealth_Cooldown[m_iWeapon]          = StringToFloat( m_sValues[1] );
        m_flBonkHealth_OverHealBonusCap[m_iWeapon]  = StringToFloat( m_sValues[2] );
        m_bBonkHealth_ATTRIBUTE[m_iWeapon]          = true;
        m_aAction = Plugin_Handled;
    }
    ...
    {
        m_flCritOnHealthPointsThreshold_Threshold[m_iWeapon]    = StringToFloat( m_sValue );
        m_bCritOnHealthPointsThreshold_ATTRIBUTE[m_iWeapon]     = true;
        m_aAction = Plugin_Handled;
    }
    ...
    {
        m_flMiniCritDisguisedCLOSERANGE_Range[m_iWeapon]    = StringToFloat( m_sValue );
        m_bMiniCritDisguisedCLOSERANGE_ATTRIBUTE[m_iWeapon] = true;
        m_aAction = Plugin_Handled;
    }
    ...
    {
        m_flCritDisguisedCLOSERANGE_Range[m_iWeapon]    = StringToFloat( m_sValue );
        m_bCritDisguisedCLOSERANGE_ATTRIBUTE[m_iWeapon] = true;
        m_aAction = Plugin_Handled;
    }
    ...
    {
        m_flNonCriticalDamageModifier_Multiplier[m_iWeapon] = StringToFloat( m_sValue );
        m_bNonCriticalDamageModifier_ATTRIBUTE[m_iWeapon]   = true;
        m_aAction = Plugin_Handled;
    }
    ...
    {
        m_flRageDecrease_Amount[m_iWeapon]          = StringToFloat( m_sValue );
        m_bRageDecrease_ATTRIBUTE[m_iWeapon]        = true;
        m_aAction = Plugin_Handled;
    }
    ...
    {
        m_bSpeedBoostFire_ATTRIBUTE[m_iWeapon]      = true;
        m_aAction = Plugin_Handled;
    }
    /* Disorientate On Hit
     *
    ...
    {
        m_bDisorientateOnHit_ATTRIBUTE[m_iWeapon]   = true;
        m_aAction = Plugin_Handled;
    }
    /* No Backstab
     *
    ...
    {
        m_flNoBackstab_Damage[m_iWeapon]   = StringToFloat( m_sValue );
        m_bNoBackstab_ATTRIBUTE[m_iWeapon]  = true;
        m_aAction = Plugin_Handled;
    }
    ...
    {
        m_bChargedAirblast_SOUNDONLY_ATTRIBUTE[m_iWeapon]   = true;
        m_aAction = Plugin_Handled;
    }
    ...
    else if ( StrEqual( m_sAttribute, "meet the sniper combo" ) )
    {
        ...
        m_flSniperCombo_DMGA[m_iWeapon]     = StringToFloat( m_sValues[0] );
        m_flSniperCombo_DMGB[m_iWeapon]     = StringToFloat( m_sValues[1] );
        m_flSniperCombo_DMGC[m_iWeapon]     = StringToFloat( m_sValues[2] );
        m_bSniperCombo_ATTRIBUTE[m_iWeapon] = true;
        m_aAction = Plugin_Handled;
    }
    /* Meet The Pyro Combo
     *
    ...
    else if ( StrEqual( m_sAttribute, "meet the pyro combo" ) )
    {
        ...
        m_flPyroCombo_DMGA[m_iWeapon]       = StringToFloat( m_sValues[0] );
        m_flPyroCombo_DMGB[m_iWeapon]       = StringToFloat( m_sValues[1] );
        m_flPyroCombo_DMGC[m_iWeapon]       = StringToFloat( m_sValues[2] );
        m_bPyroCombo_ATTRIBUTE[m_iWeapon]   = true;
        m_aAction = Plugin_Handled;
    }
    /* Increased Pushscale
     *
    ...
    {
        m_flIncreasedPushScale_Scale[m_iWeapon]     = StringToFloat( m_sValue );
        m_bIncreasedPushScale_ATTRIBUTE[m_iWeapon]  = true;
        m_aAction = Plugin_Handled;
    }
    /* Disarm Silent
     *
    ...
    {
        m_flDisarmSilent_Duration[m_iWeapon] = StringToFloat( m_sValue );
        m_bDisarmSilent_ATTRIBUTE[m_iWeapon] = true;
        m_aAction = Plugin_Handled;
    }
    /* Miss Causes Delay
     *
    ...
    {
        m_flMissCauseDelay_Delay[m_iWeapon]     = StringToFloat( m_sValue );
        m_bMissCauseDelay_ATTRIBUTE[m_iWeapon]  = true;
        m_aAction = Plugin_Handled;
    }
    /* Electroshock
     *
    ...
    else if ( StrEqual( m_sAttribute, "electroshock" ) )
    {
        ...
        m_flElectroshock_Charge[m_iWeapon]      = StringToFloat( m_sValues[0] );
        m_flElectroshock_Duration[m_iWeapon]    = StringToFloat( m_sValues[1] );
        m_bElectroshock_ATTRIBUTE[m_iWeapon]    = true;
        m_aAction = Plugin_Handled;
    }
    ...
    {
        m_bCritHealingMedic_ATTRIBUTE[m_iWeapon] = true;
        m_aAction = Plugin_Handled;
    }
    /* Democharge On Hit
     *
    ...
    {
        m_flDemoChargeOnHit_Charge[m_iWeapon]   = StringToFloat( m_sValue );
        m_bDemoChargeOnHit_ATTRIBUTE[m_iWeapon] = true;
        m_aAction = Plugin_Handled;
    }
    ...
    {
        m_bPissYourselfOnMiss_ATTRIBUTE[m_iWeapon] = true;
        m_aAction = Plugin_Handled;
    }
    /* Disable Primary
     *
    ...
    {
        m_bDisablePrimAlt_ATTRIBUTE[m_iWeapon] = true;
        m_aAction = Plugin_Handled;
    }
    /* Metal Shield
     *
    ...
    else if ( StrEqual( m_sAttribute, "metal shield" ) )
    {
        ...
        m_flMetalShield_DamageAbsorb[m_iWeapon]         = StringToFloat( m_sValues[0] );
        m_flMetalShield_DamageAbsorbMetalPct[m_iWeapon] = StringToFloat( m_sValues[1] );
        m_bMetalShield_ATTRIBUTE[m_iWeapon]             = true;
        m_aAction = Plugin_Handled;
    }
...
public Action:OnTakeDamage( m_iVictim, &m_iAttacker, &m_iInflictor, &Float:m_flDamage, &m_iType, &m_iWeapon, Float:m_flForce[3], Float:m_flPosition[3], m_iCustom )
{
    ...
    {
        if ( HasAttribute( m_iVictim, _, m_bLevelUpSystem_DamageReceived_ATTRIBUTE, true ) && m_flFloats[m_iVictim][m_flTakeDamageCharge] >= 400.0 && GetAttributeValue( m_iVictim, _, m_bLevelUpSystem_DamageReceived_ATTRIBUTE, m_flLevelUpSystem_DamageReceived_CriticalDamageResistance, true ) == 0.0 ) {
        ...
        if ( m_flDamage >= 1.0 )
        {
            if ( HasAttribute( m_iVictim, _, m_bElectroshock_ATTRIBUTE ) )
            {
                if ( m_flFloats[m_iVictim][m_flElectroshock] >= 100.0 )
                {
                    if ( TF2_DamageWillKill( m_iVictim, m_flDamage, true ) )
                    {
                        ...
                        TF2_AddCondition( m_iVictim, TFCond_Ubercharged, GetAttributeValue( m_iVictim, _, m_bElectroshock_ATTRIBUTE, m_flElectroshock_Duration ) );
            ...
            if ( m_flDamage >= 1.0 && m_iWeapon != -1 )
            {
                ...
                if ( m_bHasAttribute[m_iWeapon] )
                {
                     ...
                     *
                     * -------------------------------------------------- */
                    if ( m_bExplosiveDamage_ATTRIBUTE[m_iWeapon] )
                    {
                        ...
                        new Float:fScale = m_flDamage * m_flExplosiveDamage_Force[m_iWeapon];
                        ...
                        for ( new i = 1 ; i <= MaxClients ; i++ )
                        {
                            if ( i != m_iAttacker && IsClientInGame( i ) && IsPlayerAlive( i ) && GetClientTeam( i ) != GetClientTeam( m_iAttacker ) )
                            {
                                if ( !TF2_IsPlayerInCondition( i, TFCond_Ubercharged ) )
                                {
                                    ...
                                    if ( distance <= m_flExplosiveDamage_Radius[m_iWeapon] )
                                    {
                                        decl Handle:m_hSee;
                                        ...
                                        if ( m_hSee != INVALID_HANDLE )
                                        {
                                            if ( !TR_DidHit( m_hSee ) )
                                            {
                                                ...
                                                if ( distance > 73.0 )
                                                    dmg_reduction = ( m_flDamage * ( m_flExplosiveDamage_Radius[m_iWeapon] - ( ( distance - 73.0 ) * 0.5 ) ) / m_flExplosiveDamage_Radius[m_iWeapon] ) / m_flDamage;

                                                DealDamage( i, RoundToFloor( ( ( m_iExplosiveDamage_DamageMode[m_iWeapon] == 1 ? m_flDamage : 1.0 ) * m_flExplosiveDamage_Damage[m_iWeapon] ) * dmg_reduction ), m_iAttacker, ( m_iType & TF_DMG_CRIT ? TF_DMG_ALWAYSGIB|TF_DMG_BLAST|TF_DMG_CRIT|m_iType : TF_DMG_ALWAYSGIB|TF_DMG_BLAST|m_iType ), "pumpkindeath" );
                                            }
                                        }
                ...
                //-//
                    if ( m_bLevelUpSystem_DamageDone_ATTRIBUTE[m_iWeapon] )
                    {
                        if ( m_flFloats[m_iAttacker][m_flDamageCharge] >= 200.0 ) m_flDamage *= m_flLevelUpSystem_DamageDone_BonusDamage[m_iWeapon];
                        if ( m_flFloats[m_iAttacker][m_flDamageCharge] >= 300.0 ) {
                            if ( m_flLevelUpSystem_DamageDone_CriticalChance[m_iWeapon] > GetRandomFloat( 0.0, 1.0 ) ) m_iType = TF_DMG_CRIT|m_iType;
                        }
                    }
                //-//
                    if ( m_bNonCriticalDamageModifier_ATTRIBUTE[m_iWeapon] )
                    {
                        if ( !( m_iType & TF_DMG_CRIT ) && !IsCritBoosted( m_iAttacker ) ) m_flDamage *= m_flNonCriticalDamageModifier_Multiplier[m_iWeapon];
                    }
                //-//
                    if ( m_bSniperCombo_ATTRIBUTE[m_iWeapon] )
                    {
                ...
                //-//
                    if ( m_bPyroCombo_ATTRIBUTE[m_iWeapon] )
                    {
                        ...
                        if ( m_iIntegers[m_iAttacker][m_iPyroComboHit] <= 1 ) {
                            Format( m_strSound, sizeof( m_strSound ), SOUND_IMPACT_A );
                            m_flDamage *= m_flPyroCombo_DMGA[m_iWeapon];
                        }
                        else if ( m_iIntegers[m_iAttacker][m_iPyroComboHit] == 2 ) {
                            Format( m_strSound, sizeof( m_strSound ), SOUND_IMPACT_B );
                            m_flDamage *= m_flPyroCombo_DMGB[m_iWeapon];
                        }
                     ...
                     *
                     * -------------------------------------------------- */
                    if ( m_bUberchargeToDamage_ATTRIBUTE[m_iWeapon] )
                    {
                        new Float:m_flUbercharge = TF2_GetClientUberLevel( m_iAttacker ) * m_flUberchargeToDamage_Multiplier[m_iWeapon];
                        m_flDamage += m_flUbercharge;
                    }
                //-//
                    if ( m_bEnemyUberchargeToDamage_ATTRIBUTE[m_iWeapon] )
                    {
                        new Float:m_flEnemyUbercharge = TF2_GetClientUberLevel( m_iVictim ) * m_flEnemyUberchargeToDamage_Multiplier[m_iWeapon];
                     ...
                     *
                     * -------------------------------------------------- */
                    if ( m_bNoBackstab_ATTRIBUTE[m_iWeapon] && TF2_GetPlayerClass( m_iAttacker ) == TFClass_Spy && m_iCustom == TF_CUSTOM_BACKSTAB )
                    {
                        m_iType = TF_DMG_MELEE;
                        m_flDamage = m_flNoBackstab_Damage[m_iWeapon];
                    }

                    /* Critical.
                     *
                     * -------------------------------------------------- */
                    if ( m_bCritOnHealthPointsThreshold_ATTRIBUTE[m_iWeapon] && !( m_iType & TF_DMG_CRIT ) ) {
                        if ( GetClientHealth( m_iAttacker ) <= m_flCritOnHealthPointsThreshold_Threshold[m_iWeapon] * TF2_GetClientMaxHealth( m_iAttacker ) ) m_iType = TF_DMG_CRIT|m_iType;
                    }
                //-//
                    if ( m_bMiniCritDisguisedCLOSERANGE_ATTRIBUTE[m_iWeapon] && !( m_iType & TF_DMG_CRIT ) && TF2_IsPlayerInCondition( m_iAttacker, TFCond_Disguised ) && TF2_GetPlayerClass( m_iAttacker ) == TFClass_Spy )
                    {
                        ...
                        new Float:distance = GetVectorDistance( flPos1, flPos2 );
                        if ( distance < m_flMiniCritDisguisedCLOSERANGE_Range[m_iWeapon] )  TF2_AddCondition( m_iAttacker, TFCond_Buffed, 0.01 );
                    }
                //-//
                    if ( m_bCritDisguisedCLOSERANGE_ATTRIBUTE[m_iWeapon] && !( m_iType & TF_DMG_CRIT ) && TF2_IsPlayerInCondition( m_iAttacker, TFCond_Disguised ) && TF2_GetPlayerClass( m_iAttacker ) == TFClass_Spy )
                    {
                        new Float:flPos1[3], Float:flPos2[3];
                        GetClientAbsOrigin( m_iAttacker, flPos1 );
                        GetClientAbsOrigin( m_iVictim, flPos2 );
                        ...
                        new Float:distance = GetVectorDistance( flPos1, flPos2 );
                        if ( distance < m_flCritDisguisedCLOSERANGE_Range[m_iWeapon] ) m_iType = TF_DMG_CRIT|m_iType;
                    }
                //-//
                    if ( m_bCritHealingMedic_ATTRIBUTE[m_iWeapon] && !( m_iType & TF_DMG_CRIT ) ) {
            ...
            if ( HasAttribute( m_iVictim, _, m_bLevelUpSystem_DamageReceived_ATTRIBUTE, true ) && m_flFloats[m_iVictim][m_flTakeDamageCharge] >= 400.0 ) {
                if ( m_iType & TF_DMG_CRIT || IsCritBoosted( m_iAttacker ) ) m_flDamage *= GetAttributeValue( m_iVictim, _, m_bLevelUpSystem_DamageReceived_ATTRIBUTE, m_flLevelUpSystem_DamageReceived_CriticalDamageResistance );
            }
            if ( HasAttribute( m_iVictim, _, m_bMetalShield_ATTRIBUTE ) )
            {
                ...
                if ( metal > 0 )
                {
                    new Float:metal_lost = m_flDamage * GetAttributeValue( m_iVictim, _, m_bMetalShield_ATTRIBUTE, m_flMetalShield_DamageAbsorb ) * GetAttributeValue( m_iVictim, _, m_bMetalShield_ATTRIBUTE, m_flMetalShield_DamageAbsorbMetalPct );
                    m_flDamage *= ( 1 - GetAttributeValue( m_iVictim, _, m_bMetalShield_ATTRIBUTE, m_flMetalShield_DamageAbsorb ) );
                    if ( metal_lost > metal ) m_flDamage += ( ( metal_lost / GetAttributeValue( m_iVictim, _, m_bMetalShield_ATTRIBUTE, m_flMetalShield_DamageAbsorbMetalPct ) ) - metal );
...
public Action:OnTakeDamageAlive( m_iVictim, &m_iAttacker, &m_iInflictor, &Float:m_flDamage, &m_iType, &m_iWeapon, Float:m_flForce[3], Float:m_flPosition[3], m_iCustom )
{
        ...
        && !HasInvulnerabilityCond( m_iVictim ) )
    {
        ...
        {
            if ( GetAttributeValue( m_iVictim, _, m_bMiniMann_ATTRIBUTE, m_iMiniMann_Type ) == 2 ) TF2_AddCondition( m_iAttacker, TFCond_Buffed, 0.01 );
            else {
    ...
    //-//
        ...
        {
            new Float:m_flValue;
            m_flValue = m_flDamage * GetAttributeValue( m_iVictim, _, m_bLevelUpSystem_DamageReceived_ATTRIBUTE, m_flLevelUpSystem_DamageReceived_Charge ) * 0.01;
    ...
    //-//
        ...
        {
            new Float:m_flCharge = m_flDamage * GetAttributeValue( m_iAttacker, _, m_bRespawnWhereYouDied_ATTRIBUTE, m_flRespawnWhereYouDied_Charge ) * 0.01;
    ...
    //-//
        ...
        {
            new Float:m_flValue = m_flDamage * GetAttributeValue( m_iAttacker, _, m_bElectroshock_ATTRIBUTE, m_flElectroshock_Charge ) * 0.01;
        ...
        {
            if ( m_bMarkVictim_ATTRIBUTE[m_iWeapon] )
            {
                ...
                if ( m_hTimers[m_iVictim][m_hMarkVictim_TimerDuration] == INVALID_HANDLE && !s_bGlowEnabled[m_iVictim] && m_iIntegers[m_iAttacker][m_iMarkedVictim] < m_iMarkVictim_MaximumStack[m_iWeapon] )
                {
                    m_iIntegers[m_iAttacker][m_iMarkedVictim]++;
                    ...
                    m_hTimers[m_iVictim][m_hMarkVictim_TimerDuration] = CreateDataTimer( m_flMarkVictim_Duration[m_iWeapon], m_tMarkVictim, m_hData01 );
                    WritePackCell( m_hData01, m_iVictim );
                    WritePackCell( m_hData01, m_iAttacker );
                }
            }
        //-//
            if ( m_bMarkVictimForDeath_ATTRIBUTE[m_iWeapon] )
            {
                g_pMarker[m_iVictim] = m_iAttacker;
                ...
                if ( m_hTimers[m_iVictim][m_hMarkVictimForDeath_TimerDuration] == INVALID_HANDLE && m_iIntegers[m_iAttacker][m_iMarkedVictimForDeath] < m_iMarkVictimForDeath_MaximumStack[m_iWeapon] )
                {
                    m_iIntegers[m_iAttacker][m_iMarkedVictimForDeath]++;
                    TF2_AddCondition( m_iVictim, TFCond_MarkedForDeath, m_flMarkVictimForDeath_Duration[m_iWeapon] );

                    new Handle:m_hData02 = CreateDataPack();
                    m_hTimers[m_iVictim][m_hMarkVictimForDeath_TimerDuration] = CreateDataTimer( m_flMarkVictimForDeath_Duration[m_iWeapon], m_tMarkVictimForDeath, m_hData02 );
                    WritePackCell( m_hData02, m_iVictim );
                    WritePackCell( m_hData02, m_iAttacker );
                }
            }
        //-//
            if ( m_bDisableSlot_ATTRIBUTE[m_iWeapon] )
            {
                if ( MakeSlotSleep( m_iVictim, m_iAttacker, m_iDisableSlot_Slot[m_iWeapon], m_flDisableSlot_Duration[m_iWeapon] ) )
                {
        ...
        //-//
            if ( m_bDisorientateOnHit_ATTRIBUTE[m_iWeapon] )
            {
        ...
        //-//
            if ( m_bIncreasedPushScale_ATTRIBUTE[m_iWeapon] )
            {
                decl Float:m_vAng[3], Float:m_vVelocity[3];
                GetClientEyeAngles( m_iAttacker, m_vAng );
                m_vAng[0] = -40.0;
                AnglesToVelocity( m_vAng, m_vVelocity, ( 200.0 * m_flIncreasedPushScale_Scale[m_iWeapon] ) ); //200.0
                        
                TeleportEntity( m_iVictim, NULL_VECTOR, NULL_VECTOR, m_vVelocity );
            }
        //-//
            if ( m_bDisarmSilent_ATTRIBUTE[m_iWeapon] )
            {
                MakeSlotSleep( m_iVictim, m_iAttacker, 0, m_flDisarmSilent_Duration[m_iWeapon], false );
                MakeSlotSleep( m_iVictim, m_iAttacker, 1, m_flDisarmSilent_Duration[m_iWeapon], false );
            }
            if ( m_iVictim != m_iAttacker )
            {
                if ( m_bRageDecrease_ATTRIBUTE[m_iWeapon] )
                {
            ...
            //-//
                if ( m_bMissCauseDelay_ATTRIBUTE[m_iWeapon] )
                {
            ...
            //-//
                if ( m_bDemoChargeOnHit_ATTRIBUTE[m_iWeapon] )
                {
                    new Float:m_flChargeMeter = GetEntPropFloat( m_iAttacker, Prop_Send, "m_flChargeMeter" );
                    m_flChargeMeter += m_flDemoChargeOnHit_Charge[m_iWeapon];
            ...
            //-//
                if ( m_bPissYourselfOnMiss_ATTRIBUTE[m_iWeapon] )
                    m_bBools[m_iAttacker][m_bLastWasMissPISS] = false;
            //-//
                if ( m_bJumpBonus_ATTRIBUTE[m_iWeapon] )
                {
                    if ( ( m_iIntegers[m_iAttacker][m_iJumpAmount] + m_iIntegers[m_iAttacker][m_iJumpAmountBase] ) > m_iJumpBonus_BaseJumps[m_iWeapon] )
                    {
                        m_iIntegers[m_iAttacker][m_iJumpAmount] += m_iJumpBonus_Hit[m_iWeapon];
                        if ( m_iIntegers[m_iAttacker][m_iJumpAmount] > m_iJumpBonus_MaxJumps[m_iWeapon] ) m_iIntegers[m_iAttacker][m_iJumpAmount] = m_iJumpBonus_MaxJumps[m_iWeapon];
                    }
                    else
                    {
                        if ( m_iIntegers[m_iAttacker][m_iJumpAmount] < 0 ) m_iIntegers[m_iAttacker][m_iJumpAmount] = 0;
                        /* ** Hacky way to set correct jumps because the Unique Base Jump make the 'last' ( 1/max ) not used, Idk why, but that's not a big deal. ** */
                        if ( m_iJumpBonus_BaseJumps[m_iWeapon] == 1 && m_iIntegers[m_iAttacker][m_iJumpAmount] == 0 ) m_iIntegers[m_iAttacker][m_iJumpAmount] += ( 1+m_iJumpBonus_Hit[m_iWeapon] );
                        /* ** ! ** */
                        else if ( m_iJumpBonus_BaseJumps[m_iWeapon] == 2 ) m_iIntegers[m_iAttacker][m_iJumpAmount] += m_iJumpBonus_Hit[m_iWeapon];
                    }
                }
                if ( m_bLevelUpSystem_DamageDone_ATTRIBUTE[m_iWeapon] )
                {
                    new Float:m_flValue = m_flDamage * ( m_flLevelUpSystem_DamageDone_Charge[m_iWeapon] * 0.01 );
                    ...
                    if ( m_flFloats[m_iAttacker][m_flDamageCharge] >= 100.0 )
                        TF2_HealPlayer( m_iAttacker, m_flDamage * m_flLevelUpSystem_DamageDone_Lifesteal[m_iWeapon], 1.0, true );
                ...
                if ( m_bLevelUpSystem_DamageReceived_ATTRIBUTE[m_iWeapon] )
                {
                    if ( m_flFloats[m_iAttacker][m_flTakeDamageCharge] >= 100.0 )
                        TF2_HealPlayer( m_iAttacker, m_flDamage * m_flLevelUpSystem_DamageReceived_Lifesteal[m_iWeapon], 1.0, true );
                }
            }
        }
    }
...
public OnTakeDamagePost( m_iVictim, m_iAttacker, m_iInflictor, Float:m_flDamage, m_iType, m_iWeapon, Float:m_flForce[3], Float:m_flPosition[3] )
{
        ...
        && m_bHasAttribute[m_iWeapon] )
    {
        if ( m_iType & TF_DMG_CRIT || IsCritBoosted( m_iAttacker ) )
        {
            if ( m_bExplosiveCriticalDamage_ATTRIBUTE[m_iWeapon] )
            {
                new particle = CreateEntityByName( "info_particle_system" );
                if ( IsValidEntity( particle ) )
                {
                ...
                new Float:fScale = ( m_flDamage * 3.0 ) * m_flExplosiveCriticalDamage_Force[m_iWeapon];
                ...
                for ( new i = 1 ; i <= MaxClients ; i++ )
                {
                    if ( i != m_iAttacker && IsClientInGame( i ) && IsPlayerAlive( i ) && GetClientTeam( i ) != GetClientTeam( m_iAttacker ) )
                    {
                        if ( !TF2_IsPlayerInCondition( i, TFCond_Ubercharged ) )
                        {
                            ...
                            new Float:distance = GetVectorDistance( flPos1, flPos2 );
                            if ( distance <= m_flExplosiveCriticalDamage_Radius[m_iWeapon] )
                            {
                                decl Handle:m_hSee;
                                ( m_hSee = INVALID_HANDLE );
                                ...
                                if ( m_hSee != INVALID_HANDLE )
                                {
                                    if ( !TR_DidHit( m_hSee ) )
                                    {
                                        ...
                                        new Float:dmg_reduction = 1.0;
                                        if ( distance > 73.0 )
                                            dmg_reduction = ( m_flDamage * ( m_flExplosiveCriticalDamage_Radius[m_iWeapon] - ( ( distance - 73.0 ) * 0.5 ) ) / m_flExplosiveCriticalDamage_Radius[m_iWeapon] ) / m_flDamage;
            
                                        DealDamage( i, RoundToFloor( ( ( m_iExplosiveCriticalDamage_DamageMode[m_iWeapon] == 1 ? m_flDamage : 1.0 ) * m_flExplosiveCriticalDamage_Damage[m_iWeapon] ) * dmg_reduction ), m_iAttacker, TF_DMG_ALWAYSGIB|TF_DMG_BLAST|TF_DMG_CRIT|m_iType, "pumpkindeath" );
                                    }
                                }
...
public Action:TF2_CalcIsAttackCritical( m_iClient, m_iWeapon, String:m_strName[], &bool:m_bResult )
{
    ...
    //-//
        if ( m_bMissCauseDelay_ATTRIBUTE[m_iWeapon] && m_hTimers[m_iClient][m_hMissCauseDelay_TimerDuration] == INVALID_HANDLE && ( GetEntProp( m_iWeapon, Prop_Send, "m_bLowered" ) == 0 ) )
        {
            ...
            WritePackCell( m_hData04, m_iSlot );
...
public Action:Event_Death( Handle:m_hEvent, const String:m_strName[], bool:m_bDontBroadcast )
{
    ...
    if ( IsValidClient( m_iVictim ) )
    {
        if ( m_iVictim && !m_bFeignDeath )
        {
            ...
            {
                CreateTimer( GetAttributeValue( m_iVictim, _, m_bRespawnWhereYouDied_ATTRIBUTE, m_flRespawnWhereYouDied_Delay ), m_tRespawnWhereYouDied, m_iVictim );
            }
            if ( m_hTimers[m_iVictim][m_hMarkVictim_TimerDuration] != INVALID_HANDLE )
            {
        ...
        if ( m_iKiller != m_iVictim )
        {
            if ( IsValidClient( m_iKiller ) )
            {
                ...
                {
                    if ( m_bUberchargeOnKill_ATTRIBUTE[m_iWeapon] )
                        TF2_SetClientUberLevel( m_iKiller, TF2_GetClientUberLevel( m_iKiller ) + m_flUberchargeOnKill_Amount[m_iWeapon] );
                //-//
                    if ( m_bJumpBonus_ATTRIBUTE[m_iWeapon] )
                    {
                        m_iIntegers[m_iKiller][m_iJumpAmount] += m_iJumpBonus_Kill[m_iWeapon];

                        if ( m_iIntegers[m_iKiller][m_iJumpAmount] > m_iJumpBonus_MaxJumps[m_iWeapon] ) m_iIntegers[m_iKiller][m_iJumpAmount] = m_iJumpBonus_MaxJumps[m_iWeapon];
                    }
                }
            }
        }
...
public OnEntityDestroyed( m_iEntity )
{
    ...
    m_bMarkVictim_ATTRIBUTE[m_iEntity]              = false;
    m_flMarkVictim_Duration[m_iEntity]              = 0.0;
    m_iMarkVictim_MaximumStack[m_iEntity]           = 0;

    m_bMarkVictimForDeath_ATTRIBUTE[m_iEntity]      = false;
    m_flMarkVictimForDeath_Duration[m_iEntity]      = 0.0;
    m_iMarkVictimForDeath_MaximumStack[m_iEntity]   = 0;

    m_bDisableSlot_ATTRIBUTE[m_iEntity]             = false;
    m_flDisableSlot_Duration[m_iEntity]             = 0.0;
    m_iDisableSlot_Slot[m_iEntity]                  = 0;

    m_bDisarmSilent_ATTRIBUTE[m_iEntity]            = false;
    m_flDisarmSilent_Duration[m_iEntity]            = 0.0;

    m_bSniperCombo_ATTRIBUTE[m_iEntity]             = false;
    m_flSniperCombo_DMGA[m_iEntity]                 = 0.0;
    m_flSniperCombo_DMGB[m_iEntity]                 = 0.0;
    m_flSniperCombo_DMGC[m_iEntity]                 = 0.0;

    m_bIncreasedPushScale_ATTRIBUTE[m_iEntity]      = false;
    m_flIncreasedPushScale_Scale[m_iEntity]         = 0.0;

    m_bMissCauseDelay_ATTRIBUTE[m_iEntity]          = false;
    m_flMissCauseDelay_Delay[m_iEntity]             = 0.0;

    m_bCritHealingMedic_ATTRIBUTE[m_iEntity]        = false;

    m_bDemoChargeOnHit_ATTRIBUTE[m_iEntity]         = false;
    m_flDemoChargeOnHit_Charge[m_iEntity]           = 0.0;

    m_bPyroCombo_ATTRIBUTE[m_iEntity]               = false;
    m_flPyroCombo_DMGA[m_iEntity]                   = 0.0;
    m_flPyroCombo_DMGB[m_iEntity]                   = 0.0;
    m_flPyroCombo_DMGC[m_iEntity]                   = 0.0;

    m_bPissYourselfOnMiss_ATTRIBUTE[m_iEntity]      = false;


    /* On Crit
     * ---------------------------------------------------------------------- */

    m_bMiniCritDisguisedCLOSERANGE_ATTRIBUTE[m_iEntity] = false;
    m_flMiniCritDisguisedCLOSERANGE_Range[m_iEntity]    = 0.0;

    m_bCritDisguisedCLOSERANGE_ATTRIBUTE[m_iEntity]     = false;
    m_flCritDisguisedCLOSERANGE_Range[m_iEntity]        = 0.0;


    /* On Kill
     * ---------------------------------------------------------------------- */

    m_bUberchargeOnKill_ATTRIBUTE[m_iEntity]    = false;
    m_flUberchargeOnKill_Amount[m_iEntity]      = 0.0;


    /* On Damage
     * ---------------------------------------------------------------------- */

    m_bUberchargeToDamage_ATTRIBUTE[m_iEntity]                          = false;
    m_flUberchargeToDamage_Multiplier[m_iEntity]                        = 0.0;

    m_bEnemyUberchargeToDamage_ATTRIBUTE[m_iEntity]                     = false;
    m_flEnemyUberchargeToDamage_Multiplier[m_iEntity]                   = 0.0;

    m_bExplosiveDamage_ATTRIBUTE[m_iEntity]                             = false;
    m_flExplosiveDamage_Damage[m_iEntity]                               = 0.0;
    m_flExplosiveDamage_Force[m_iEntity]                                = 0.0;
    m_flExplosiveDamage_Radius[m_iEntity]                               = 0.0;
    m_iExplosiveDamage_DamageMode[m_iEntity]                            = 0;

    m_bExplosiveCriticalDamage_ATTRIBUTE[m_iEntity]                     = false;
    m_flExplosiveCriticalDamage_Damage[m_iEntity]                       = 0.0;
    m_flExplosiveCriticalDamage_Force[m_iEntity]                        = 0.0;
    m_flExplosiveCriticalDamage_Radius[m_iEntity]                       = 0.0;
    m_iExplosiveCriticalDamage_DamageMode[m_iEntity]                    = 0;

    m_bLevelUpSystem_DamageDone_ATTRIBUTE[m_iEntity]                    = false;
    m_flLevelUpSystem_DamageDone_BonusDamage[m_iEntity]                 = 0.0;
    m_flLevelUpSystem_DamageDone_Charge[m_iEntity]                      = 0.0;
    m_flLevelUpSystem_DamageDone_CriticalChance[m_iEntity]              = 0.0;
    m_flLevelUpSystem_DamageDone_Lifesteal[m_iEntity]                   = 0.0;
    m_flLevelUpSystem_DamageDone_PocketUberchargeDuration[m_iEntity]    = 0.0;

    m_bNonCriticalDamageModifier_ATTRIBUTE[m_iEntity]                   = false;
    m_flNonCriticalDamageModifier_Multiplier[m_iEntity]                 = 0.0;

    m_bFlyWhileShooting_ATTRIBUTE[m_iEntity]                            = false;

    m_bDisorientateOnHit_ATTRIBUTE[m_iEntity]                           = false;

    m_bNoBackstab_ATTRIBUTE[m_iEntity]                                  = false;
    m_flNoBackstab_Damage[m_iEntity]                                    = 0.0;

    m_bElectroshock_ATTRIBUTE[m_iEntity]                                = false;
    m_flElectroshock_Charge[m_iEntity]                                  = 0.0;
    m_flElectroshock_Duration[m_iEntity]                                = 0.0;


    /* On Prethink
     * ---------------------------------------------------------------------- */

    m_bSpeedCloak_ATTRIBUTE[m_iEntity]                      = false;
    m_flSpeedCloak_Amount[m_iEntity]                        = 0.0;

    m_bDemoCharge_Ubercharge_ATTRIBUTE[m_iEntity]           = false;

    m_bDemoCharge_Invisibility_ATTRIBUTE[m_iEntity]         = false;

    m_bCritOnHealthPointsThreshold_ATTRIBUTE[m_iEntity]     = false;
    m_flCritOnHealthPointsThreshold_Threshold[m_iEntity]    = 0.0;

    m_bSpeedBoostFire_ATTRIBUTE[m_iEntity]                  = false;

    m_bRageDecrease_ATTRIBUTE[m_iEntity]                    = false;
    m_flRageDecrease_Amount[m_iEntity]                      = 0.0;

    m_bDisableAlt_ATTRIBUTE[m_iEntity]                      = false;

    m_bDisablePrimAlt_ATTRIBUTE[m_iEntity]                  = false;

    m_bJumpBonus_ATTRIBUTE[m_iEntity]                       = false;
    m_iJumpBonus_BaseJumps[m_iEntity]                       = 0;
    m_iJumpBonus_Hit[m_iEntity]                             = 0;
    m_iJumpBonus_Kill[m_iEntity]                            = 0;
    m_iJumpBonus_MaxJumps[m_iEntity]                        = 0;

    m_bChargedAirblast_SOUNDONLY_ATTRIBUTE[m_iEntity]       = false;


    /* On Damage Received
     * ---------------------------------------------------------------------- */

    m_bLevelUpSystem_DamageReceived_ATTRIBUTE[m_iEntity]                    = false;
    m_flLevelUpSystem_DamageReceived_AttackSpeed[m_iEntity]                 = 0.0;
    m_flLevelUpSystem_DamageReceived_Charge[m_iEntity]                      = 0.0;
    m_flLevelUpSystem_DamageReceived_CriticalDamageResistance[m_iEntity]    = 0.0;
    m_flLevelUpSystem_DamageReceived_HealthRegeneration[m_iEntity]          = 0.0;
    m_flLevelUpSystem_DamageReceived_Lifesteal[m_iEntity]                   = 0.0;
    m_flLevelUpSystem_DamageReceived_OldAttackSpeed[m_iEntity]              = 0.0;
    m_flLevelUpSystem_DamageReceived_OldHealthRegeneration[m_iEntity]       = 0.0;

    m_bMetalShield_ATTRIBUTE[m_iEntity]                                     = false;
    m_flMetalShield_DamageAbsorb[m_iEntity]                                 = 0.0;
    m_flMetalShield_DamageAbsorbMetalPct[m_iEntity]                         = 0.0;


    /* To Activate
     * ---------------------------------------------------------------------- */

    m_bAddCondAltFire_ATTRIBUTE[m_iEntity]      = false;
    m_flAddCondAltFire_Duration[m_iEntity]      = 0.0;
    m_flAddCondAltFire_HealthPoints[m_iEntity]  = 0.0;
    m_iAddCondAltFire_ID[m_iEntity]             = 0;

    m_bMiniMann_ATTRIBUTE[m_iEntity]            = false;
    m_flMiniMann_Cooldown[m_iEntity]            = 0.0;
    m_flMiniMann_Duration[m_iEntity]            = 0.0;
    m_flMiniMann_Resize[m_iEntity]              = 0.0;
    m_iMiniMann_Speed[m_iEntity]                = 0;
    m_iMiniMann_Type[m_iEntity]                 = 0;

    m_bDeployUbercharge_ATTRIBUTE[m_iEntity]    = false;
    m_flDeployUbercharge_Threshold[m_iEntity]   = 0.0;

    m_bBonkHealth_ATTRIBUTE[m_iEntity]          = false;
    m_flBonkHealth_Cooldown[m_iEntity]          = 0.0;
    m_flBonkHealth_Heal[m_iEntity]              = 0.0;
    m_flBonkHealth_OverHealBonusCap[m_iEntity]  = 0.0;


    /* On Death
     * ---------------------------------------------------------------------- */

    m_bRespawnWhereYouDied_ATTRIBUTE[m_iEntity] = false;
    m_flRespawnWhereYouDied_Charge[m_iEntity]   = 0.0;
    m_flRespawnWhereYouDied_Delay[m_iEntity]    = 0.0;
}
// -
// --
// ---
...
public Action:m_tMiniMann_Delay( Handle:timer, any:m_iClient )
{
    if ( HasAttribute( m_iClient, _, m_bMiniMann_ATTRIBUTE ) )
    {
        if ( GetAttributeValue( m_iClient, _, m_bMiniMann_ATTRIBUTE, m_iMiniMann_Speed ) == 1 )
            TF2_AddCondition( m_iClient, TFCond_SpeedBuffAlly, GetAttributeValue( m_iClient, _, m_bMiniMann_ATTRIBUTE, m_flMiniMann_Duration ) );

        new Float:m_flSize = GetAttributeValue( m_iClient, _, m_bMiniMann_ATTRIBUTE, m_flMiniMann_Resize );
        ...
        if ( IsValidEntity( secondary ) ) SetEntPropFloat( secondary, Prop_Send, "m_flEffectBarRegenTime", GetGameTime() + GetAttributeValue( m_iClient, _, m_bMiniMann_ATTRIBUTE, m_flMiniMann_Cooldown ) );
    }
...
public Action:m_tBonkHealth_Delay( Handle:timer, any:m_iClient )
{
    if ( HasAttribute( m_iClient, _, m_bBonkHealth_ATTRIBUTE ) )
    {
        TF2_HealPlayer( m_iClient, GetAttributeValue( m_iClient, _, m_bBonkHealth_ATTRIBUTE, m_flBonkHealth_Heal ), GetAttributeValue( m_iClient, _, m_bBonkHealth_ATTRIBUTE, m_flBonkHealth_OverHealBonusCap ) );

        new secondary = GetPlayerWeaponSlot( m_iClient, TFWeaponSlot_Secondary );
        if ( IsValidEntity( secondary ) ) SetEntPropFloat( secondary, Prop_Send, "m_flEffectBarRegenTime", GetGameTime() + GetAttributeValue( m_iClient, _, m_bBonkHealth_ATTRIBUTE, m_flBonkHealth_Cooldown ) );
    }
...
public Action:m_tMissCauseDelay_TimerDelay( Handle:timer, Handle:m_hData04 )
{
    ...
    if ( HasAttribute( m_iClient, _, m_bMissCauseDelay_ATTRIBUTE ) )
    {
        if ( IsValidClient( m_iClient ) )
        {
            new Float:m_flDelay = GetAttributeValue( m_iClient, _, m_bMissCauseDelay_ATTRIBUTE, m_flMissCauseDelay_Delay );
