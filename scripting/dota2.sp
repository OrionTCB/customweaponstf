...
new bool:m_bJinada_ATTRIBUTE[2049];
new Float:m_flJinada_Cooldown[2049]         = {0.0, ...};
new Float:m_flJinada_DamageMultiplier[2049] = {1.0, ...};

new bool:m_bTrueStrike_ATTRIBUTE[2049];

new bool:m_bFervor_ATTRIBUTE[2049];
new Float:m_flFervor_AttackSpeed[2049]      = {0.0, ...};
new Float:m_flFervor_OldAttackSpeed[2049]   = {0.0, ...};
new m_iFervor_MaximumStack[2049]            = {0, ...};

new bool:m_bDuel_ATTRIBUTE[2049];
new Float:m_flDuel_Cooldown[2049]           = {0.0, ...};
new Float:m_flDuel_DamageBonus[2049]        = {0.0, ...};
new Float:m_flDuel_Duration[2049]           = {0.0, ...};


    /* On Attack
     * ---------------------------------------------------------------------- */

new bool:m_bStaticField_ATTRIBUTE[2049];
new Float:m_flStaticField_DamagePct[2049]   = {0.0, ...};
new Float:m_flStaticField_Radius[2049]      = {0.0, ...};


    /* On Kill
     * ---------------------------------------------------------------------- */

new bool:m_bNecromastery_ATTRIBUTE[2049];
new Float:m_flNecromastery_BonusDamage[2049]    = {0.0, ...};
new Float:m_flNecromastery_Removal[2049]        = {0.0, ...};
new m_iNecromastery_MaximumStack[2049]          = {0, ...};
new m_iNecromastery_PoA[2049]       = {0, ...};

new bool:m_bBloodbath_ATTRIBUTE[2049];
new Float:m_flBloodbath_Heal[2049]              = {0.0, ...};
new Float:m_flBloodbath_Radius[2049]            = {0.0, ...};


    /* On Damage
     * ---------------------------------------------------------------------- */

new bool:m_bKillAtLowHealthPointsThreshold_ATTRIBUTE[2049];
new Float:m_flKillAtLowHealthPointsThreshold_Threshold[2049]    = {0.0, ...};

new bool:m_bKillAtHighHealthPointsThreshold_ATTRIBUTE[2049];
new Float:m_flKillAtHighHealthPointsThreshold_Threshold[2049]   = {0.0, ...};

new bool:m_bFurySwipes_ATTRIBUTE[2049];
new Float:m_flFurySwipes_BonusDamage[2049]                      = {0.0, ...};
new Float:m_flFurySwipes_Duration[2049]                         = {0.0, ...};
new m_iFurySwipes_MaximumStack[2049]                            = {0, ...};

new bool:m_bLifesteal_ATTRIBUTE[2049];
new Float:m_flLifesteal_OverHealBonusCap[2049]                  = {0.0, ...};
new Float:m_flLifesteal_Percentage[2049]                        = {0.0, ...};

new bool:m_bLifestealOnCrit_ATTRIBUTE[2049];
new Float:m_flLifestealOnCrit_OverHealBonusCap[2049]            = {0.0, ...};
new Float:m_flLifestealOnCrit_Percentage[2049]                  = {0.0, ...};

new bool:m_bDesolator_ATTRIBUTE[2049];
new Float:m_flDesolator_DamageAmp[2049]                         = {0.0, ...};
new Float:m_flDesolator_Duration[2049]                          = {0.0, ...};


    /* On Prethink
     * ---------------------------------------------------------------------- */

new bool:m_bRadiance_ATTRIBUTE[2049];
new Float:m_flRadiance_Interval[2049]               = {0.0, ...};
new Float:m_flRadiance_Radius[2049]                 = {0.0, ...};
new m_iRadiance_Damage[2049]                        = {0, ...};

new bool:m_bRadiance_SubAbility_ATTRIBUTE[2049];
new Float:m_flRadiance_SubAbility_Chance[2049]      = {0.0, ...};


    /* On Chance
     * ---------------------------------------------------------------------- */

new bool:m_bBash_ATTRIBUTE[2049];
new Float:m_flBash_BonusDamage[2049]            = {0.0, ...};
new Float:m_flBash_Chance[2049]                 = {0.0, ...};
new Float:m_flBash_Duration[2049]               = {0.0, ...};

new bool:m_bEvasion_ATTRIBUTE[2049];
new Float:m_flEvasion_Chance[2049]              = {0.0, ...};

new bool:m_bEvasionAW2_ATTRIBUTE[2049];
new Float:m_flEvasionAW2_Add[2049]        = {0.0, ...};
new Float:m_flEvasionAW2_Removal[2049]    = {0.0, ...};
new m_iEvasionAW2_Melee[2049]             = {0, ...};
new m_iEvasionAW2_PoA[2049]   = {0, ...};


    /* On Damage Received
     * ---------------------------------------------------------------------- */

new bool:m_bBladeMail_ATTRIBUTE[2049];
new Float:m_flBladeMail_Multiplier[2049]    = {0.0, ...};

new bool:m_bCraggyExterior_ATTRIBUTE[2049];
new Float:m_flCraggyExterior_Chance[2049]   = {0.0, ...};
new Float:m_flCraggyExterior_Duration[2049] = {0.0, ...};
new Float:m_flCraggyExterior_Radius[2049]   = {0.0, ...};
new m_iCraggyExterior_Damage[2049]          = {0, ...};

new bool:m_bDispersion_ATTRIBUTE[2049];
new Float:m_flDispersion_MaxDamage[2049]    = {0.0, ...}; 
new Float:m_flDispersion_MaxRadius[2049]    = {0.0, ...};
new Float:m_flDispersion_MinRadius[2049]    = {0.0, ...};

new bool:m_bReturn_ATTRIBUTE[2049];
new Float:m_flReturn_Damage[2049]           = {0.0, ...}; 
new m_iReturn_BaseDamage[2049]              = {0, ...}; 

new bool:m_bBlockDamage_ATTRIBUTE[2049];
new Float:m_flBlockDamage_Block[2049]       = {0.0, ...}; 
new Float:m_flBlockDamage_Chance[2049]      = {0.0, ...}; 


    /* To Activate
     * ---------------------------------------------------------------------- */

new bool:m_bEnchantTotem_ATTRIBUTE[2049];
new Float:m_flEnchantTotem_BonusDamage[2049]        = {0.0, ...};
new Float:m_flEnchantTotem_Cooldown[2049]           = {0.0, ...};
new Float:m_flEnchantTotem_Duration[2049]           = {0.0, ...};

new bool:m_bOverPower_ATTRIBUTE[2049];
new Float:m_flOverPower_AttackSpeed[2049]           = {0.0, ...};
new Float:m_flOverPower_Cooldown[2049]              = {0.0, ...};
new Float:m_flOverPower_Duration[2049]              = {0.0, ...};
new Float:m_flOverPower_OldAttackSpeed[2049]        = {0.0, ...};
new m_iOverPower_Hit[2049]                          = {0, ...};

new bool:m_bEnrage_ATTRIBUTE[2049];
new Float:m_flEnrage_Cooldown[2049]                 = {0.0, ...};
new Float:m_flEnrage_Duration[2049]                 = {0.0, ...};
new Float:m_flEnrage_FurySwipeMultiplier[2049]      = {0.0, ...};
new Float:m_flEnrage_Resistance[2049]               = {0.0, ...};

new bool:m_bInnerVitality_ATTRIBUTE[2049];
new Float:m_flInnerVitality_BaseRegen[2049]         = {0.0, ...};
new Float:m_flInnerVitality_Cooldown[2049]          = {0.0, ...};
new Float:m_flInnerVitality_Duration[2049]          = {0.0, ...};
new Float:m_flInnerVitality_HealthHealAbove[2049]   = {0.0, ...};
new Float:m_flInnerVitality_HealthHealBelow[2049]   = {0.0, ...};
new Float:m_flInnerVitality_HealthThreshold[2049]   = {0.0, ...};


    /* On Death
     * ---------------------------------------------------------------------- */

new bool:m_bLastWill_ATTRIBUTE[2049];
new m_iLastWill_Damage[2049]    = {0, ...};
...
public Action:CustomWeaponsTF_OnAddAttribute( m_iWeapon, m_iClient, const String:m_sAttribute[], const String:m_sPlugin[], const String:m_sValue[] )
{
    ...
    if ( StrEqual( m_sAttribute, "bash" ) ) 
    {
        ...
        m_flBash_Chance[m_iWeapon]              = StringToFloat( m_sValues[0] );
        m_flBash_Duration[m_iWeapon]            = StringToFloat( m_sValues[1] );
        m_flBash_BonusDamage[m_iWeapon]         = StringToFloat( m_sValues[2] );
        m_bBash_ATTRIBUTE[m_iWeapon]            = true;
    ...
    {
        m_flBladeMail_Multiplier[m_iWeapon]     = StringToFloat( m_sValue );
        m_bBladeMail_ATTRIBUTE[m_iWeapon]       = true;
        m_aAction = Plugin_Handled;
    }
    /* Craggy Exterior
     *
    ...
    else if ( StrEqual( m_sAttribute, "craggy exterior" ) )
    {
        ...
        m_flCraggyExterior_Chance[m_iWeapon]    = StringToFloat( m_sValues[0] );
        m_iCraggyExterior_Damage[m_iWeapon]     = StringToInt( m_sValues[1] );
        m_flCraggyExterior_Radius[m_iWeapon]    = StringToFloat( m_sValues[2] );
        m_flCraggyExterior_Duration[m_iWeapon]  = StringToFloat( m_sValues[3] );
        m_bCraggyExterior_ATTRIBUTE[m_iWeapon]  = true;
        m_aAction = Plugin_Handled;
    }
    /* Enchant Totem
     *
    ...
    else if ( StrEqual( m_sAttribute, "enchant totem" ) )
    {
        ...
        m_flEnchantTotem_BonusDamage[m_iWeapon] = StringToFloat( m_sValues[0] );
        m_flEnchantTotem_Duration[m_iWeapon]    = StringToFloat( m_sValues[1] );
        m_flEnchantTotem_Cooldown[m_iWeapon]    = StringToFloat( m_sValues[2] );
        m_bEnchantTotem_ATTRIBUTE[m_iWeapon]    = true;
        m_aAction = Plugin_Handled;
    }
    /* Evasion
     *
    ...
    {
        m_flEvasion_Chance[m_iWeapon]           = StringToFloat( m_sValue );
        m_bEvasion_ATTRIBUTE[m_iWeapon]         = true;
        m_aAction = Plugin_Handled;
    }
    ...
    else if ( StrEqual( m_sAttribute, "evasiveness on hit" ) )
    {
        ...
        m_flEvasionAW2_Add[m_iWeapon]       = StringToFloat( m_sValues[0] );
        m_flEvasionAW2_Removal[m_iWeapon]   = StringToFloat( m_sValues[1] );
        m_iEvasionAW2_Melee[m_iWeapon]      = StringToInt( m_sValues[2] );
        m_iEvasionAW2_PoA[m_iWeapon]        = StringToInt( m_sValues[3] );
        m_bEvasionAW2_ATTRIBUTE[m_iWeapon]  = true;
        m_aAction = Plugin_Handled;
    }
    /* Fervor
     *
    ...
    else if ( StrEqual( m_sAttribute, "fervor" ) )
    {
        ...
        m_flFervor_AttackSpeed[m_iWeapon]           = StringToFloat( m_sValues[0] );
        m_iFervor_MaximumStack[m_iWeapon]           = StringToInt( m_sValues[1] );
        m_flFervor_OldAttackSpeed[m_iWeapon]        = StringToFloat( m_sValues[2] );
        m_bFervor_ATTRIBUTE[m_iWeapon]              = true;
        m_aAction = Plugin_Handled;
    }
    /* Fury Swipe
     *
    ...
    else if ( StrEqual( m_sAttribute, "fury swipe" ) )
    {
        ...
        m_flFurySwipes_BonusDamage[m_iWeapon]       = StringToFloat( m_sValues[0] );
        m_iFurySwipes_MaximumStack[m_iWeapon]       = StringToInt( m_sValues[1] );
        m_flFurySwipes_Duration[m_iWeapon]          = StringToFloat( m_sValues[2] );
        m_bFurySwipes_ATTRIBUTE[m_iWeapon]          = true;
        m_aAction = Plugin_Handled;
    }
    /* Jinada
     *
    ...
    else if ( StrEqual( m_sAttribute, "jinada attr" ) )
    {
        ...
        m_flJinada_DamageMultiplier[m_iWeapon]      = StringToFloat( m_sValues[0] );
        m_flJinada_Cooldown[m_iWeapon]              = StringToFloat( m_sValues[1] );
        m_bJinada_ATTRIBUTE[m_iWeapon]              = true;
        m_aAction = Plugin_Handled;
    }
    ...
    {
        m_flKillAtHighHealthPointsThreshold_Threshold[m_iWeapon]    = StringToFloat( m_sValue );
        m_bKillAtHighHealthPointsThreshold_ATTRIBUTE[m_iWeapon]     = true;
        m_aAction = Plugin_Handled;
    }
    ...
    {
        m_flKillAtLowHealthPointsThreshold_Threshold[m_iWeapon] = StringToFloat( m_sValue );
        m_bKillAtLowHealthPointsThreshold_ATTRIBUTE[m_iWeapon]  = true;
        m_aAction = Plugin_Handled;
    }
    /* Last Will
     *
    ...
    {
        m_iLastWill_Damage[m_iWeapon]               = StringToInt( m_sValue );
        m_bLastWill_ATTRIBUTE[m_iWeapon]            = true;
        m_aAction = Plugin_Handled;
    }
    /* Lifesteal
     *
    ...
    else if ( StrEqual( m_sAttribute, "lifesteal" ) )
    {
        ...
        m_flLifesteal_Percentage[m_iWeapon]         = StringToFloat( m_sValues[0] );
        m_flLifesteal_OverHealBonusCap[m_iWeapon]   = StringToFloat( m_sValues[1] );
        m_bLifesteal_ATTRIBUTE[m_iWeapon]           = true;
        m_aAction = Plugin_Handled;
    }
    /* Lifesteal On Crit
     *
    ...
    else if ( StrEqual( m_sAttribute, "lifesteal crit" ) )
    {
        ...
        m_flLifestealOnCrit_Percentage[m_iWeapon]       = StringToFloat( m_sValues[0] );
        m_flLifestealOnCrit_OverHealBonusCap[m_iWeapon] = StringToFloat( m_sValues[1] );
        m_bLifestealOnCrit_ATTRIBUTE[m_iWeapon]         = true;
        m_aAction = Plugin_Handled;
    }
    /* Necromastery
     *
    ...
    else if ( StrEqual( m_sAttribute, "necromastery" ) )
    {
        ...
        m_flNecromastery_BonusDamage[m_iWeapon]         = StringToFloat( m_sValues[0] );
        m_iNecromastery_MaximumStack[m_iWeapon]         = StringToInt( m_sValues[1] );
        m_flNecromastery_Removal[m_iWeapon]             = StringToFloat( m_sValues[2] );
        m_iNecromastery_PoA[m_iWeapon]      = StringToInt( m_sValues[3] );
        m_bNecromastery_ATTRIBUTE[m_iWeapon]            = true;
        m_aAction = Plugin_Handled;
    }
    /* Overpower
     *
    ...
    else if ( StrEqual( m_sAttribute, "overpower" ) )
    {
        ...
        m_flOverPower_AttackSpeed[m_iWeapon]            = StringToFloat( m_sValues[0] );
        m_flOverPower_Duration[m_iWeapon]               = StringToFloat( m_sValues[1] );
        m_iOverPower_Hit[m_iWeapon]                     = StringToInt( m_sValues[2] );
        m_flOverPower_Cooldown[m_iWeapon]               = StringToFloat( m_sValues[3] );
        m_flOverPower_OldAttackSpeed[m_iWeapon]         = StringToFloat( m_sValues[4] );
        m_bOverPower_ATTRIBUTE[m_iWeapon]               = true;
        m_aAction = Plugin_Handled;
    }
    /* Radiance
     *
    ...
    else if ( StrEqual( m_sAttribute, "radiance attr" ) )
    {
        ...
        m_iRadiance_Damage[m_iWeapon]                   = StringToInt( m_sValues[0] );
        m_flRadiance_Radius[m_iWeapon]                  = StringToFloat( m_sValues[1] );
        m_flRadiance_Interval[m_iWeapon]                = StringToFloat( m_sValues[2] );
        m_bRadiance_ATTRIBUTE[m_iWeapon]                = true;
        m_aAction = Plugin_Handled;
    }
    /* Radiance Evasion
     *
    ...
    {
        m_flRadiance_SubAbility_Chance[m_iWeapon]       = StringToFloat( m_sValue );
        m_bRadiance_SubAbility_ATTRIBUTE[m_iWeapon]     = true;
        m_aAction = Plugin_Handled;
    }
    /* True Strike
     *
    ...
    {
        m_bTrueStrike_ATTRIBUTE[m_iWeapon]  = true;
        m_aAction = Plugin_Handled;
    }
    /* Desolator
     *
    ...
    else if ( StrEqual( m_sAttribute, "desolator attr" ) )
    {
        ...
        m_flDesolator_DamageAmp[m_iWeapon]              = StringToFloat( m_sValues[0] );
        m_flDesolator_Duration[m_iWeapon]               = StringToFloat( m_sValues[1] );
        m_bDesolator_ATTRIBUTE[m_iWeapon]               = true;
        m_aAction = Plugin_Handled;
    }
    /* Dispersion
     *
    ...
    else if ( StrEqual( m_sAttribute, "dispersion attr" ) )
    {
        ...
        m_flDispersion_MaxDamage[m_iWeapon]             = StringToFloat( m_sValues[0] );
        m_flDispersion_MaxRadius[m_iWeapon]             = StringToFloat( m_sValues[1] );
        m_flDispersion_MinRadius[m_iWeapon]             = StringToFloat( m_sValues[2] );
        m_bDispersion_ATTRIBUTE[m_iWeapon]              = true;
        m_aAction = Plugin_Handled;
    }
    /* Return
     *
    ...
    else if ( StrEqual( m_sAttribute, "return attr" ) )
    {
        ...
        m_iReturn_BaseDamage[m_iWeapon]     = StringToInt( m_sValues[0] );
        m_flReturn_Damage[m_iWeapon]        = StringToFloat( m_sValues[1] );
        m_bReturn_ATTRIBUTE[m_iWeapon]      = true;
        m_aAction = Plugin_Handled;
    }
    /* Static Field
     *
    ...
    else if ( StrEqual( m_sAttribute, "static field attr" ) )
    {
        ...
        m_flStaticField_DamagePct[m_iWeapon]     = StringToFloat( m_sValues[0] );
        m_flStaticField_Radius[m_iWeapon]        = StringToFloat( m_sValues[1] );
        m_bStaticField_ATTRIBUTE[m_iWeapon]      = true;
        m_aAction = Plugin_Handled;
    }
    /* Bloodbath
     *
    ...
    else if ( StrEqual( m_sAttribute, "bloodbath" ) )
    {
        ...
        m_flBloodbath_Heal[m_iWeapon]       = StringToFloat( m_sValues[0] );
        m_flBloodbath_Radius[m_iWeapon]     = StringToFloat( m_sValues[1] );
        m_bBloodbath_ATTRIBUTE[m_iWeapon]   = true;
        m_aAction = Plugin_Handled;
    }
    /* Enrage
     *
    ...
    else if ( StrEqual( m_sAttribute, "enrage" ) )
    {
        ...
        m_flEnrage_FurySwipeMultiplier[m_iWeapon]   = StringToFloat( m_sValues[0] );
        m_flEnrage_Resistance[m_iWeapon]            = StringToFloat( m_sValues[1] );
        m_flEnrage_Duration[m_iWeapon]              = StringToFloat( m_sValues[2] );
        m_flEnrage_Cooldown[m_iWeapon]              = StringToFloat( m_sValues[3] );
        m_bEnrage_ATTRIBUTE[m_iWeapon]              = true;
        m_aAction = Plugin_Handled;
    }
    /* Inner Vitality
     *
    ...
    else if ( StrEqual( m_sAttribute, "inner vitality" ) )
    {
        ...
        m_flInnerVitality_BaseRegen[m_iWeapon]          = StringToFloat( m_sValues[0] );
        m_flInnerVitality_HealthHealAbove[m_iWeapon]    = StringToFloat( m_sValues[1] );
        m_flInnerVitality_HealthHealBelow[m_iWeapon]    = StringToFloat( m_sValues[2] );
        m_flInnerVitality_HealthThreshold[m_iWeapon]    = StringToFloat( m_sValues[3] );
        m_flInnerVitality_Duration[m_iWeapon]           = StringToFloat( m_sValues[4] );
        m_flInnerVitality_Cooldown[m_iWeapon]           = StringToFloat( m_sValues[5] );
        m_bInnerVitality_ATTRIBUTE[m_iWeapon]           = true;
        m_aAction = Plugin_Handled;
    }
    /* Block Damage
     *
    ...
    else if ( StrEqual( m_sAttribute, "block damage" ) )
    {
        ...
        m_flBlockDamage_Block[m_iWeapon]    = StringToFloat( m_sValues[0] );
        m_flBlockDamage_Chance[m_iWeapon]   = StringToFloat( m_sValues[1] );
        m_bBlockDamage_ATTRIBUTE[m_iWeapon] = true;
        m_aAction = Plugin_Handled;
    }
    /* Duel
     *
    ...
    else if ( StrEqual( m_sAttribute, "duel" ) )
    {
        ...
        m_flDuel_DamageBonus[m_iWeapon] = StringToFloat( m_sValues[0] );
        m_flDuel_Duration[m_iWeapon]    = StringToFloat( m_sValues[1] );
        m_flDuel_Cooldown[m_iWeapon]    = StringToFloat( m_sValues[2] );
        m_bDuel_ATTRIBUTE[m_iWeapon]    = true;
        m_aAction = Plugin_Handled;
    }
            ...
            && m_iAttacker != m_iVictim )
        {
            if ( HasAttribute( m_iVictim, _, m_bEvasion_ATTRIBUTE ) || HasAttribute( m_iVictim, _, m_bEvasionAW2_ATTRIBUTE ) || m_bBools[m_iAttacker][m_bRadiance_SubAbilityActive] )
            {
                    ...
                    && !HasInvulnerabilityCond( m_iVictim ) )
                {
                    ...
                    {
                        if ( m_iWeapon == -1 || !( m_bTrueStrike_ATTRIBUTE[m_iWeapon] ) ) {
                            m_flDamage = 0.0;
            ...
            */
            if ( m_flDamage >= 1.0 )
            {
                if ( m_iWeapon != -1 )
                {
                    ...
                    if ( m_bHasAttribute[m_iWeapon] && m_flDamage >= 1.0 )
                    {

                        /* Apply Enchant Totem : Increases damage before the others modifiers.
                         *
                         * -------------------------------------------------- */
                        if ( m_bEnchantTotem_ATTRIBUTE[m_iWeapon] )
                        {
                            if ( m_hTimers[m_iAttacker][m_hEnchantTotem_TimerDuration] != INVALID_HANDLE )
                            {
                                ...
                                m_flDamage *= m_flEnchantTotem_BonusDamage[m_iWeapon];
                            }
                        }
                         ...
                         *
                         * -------------------------------------------------- */
                        if ( m_bNecromastery_ATTRIBUTE[m_iWeapon] )
                            m_flDamage += ( m_iIntegers[m_iAttacker][m_iNecromastery_Souls] * m_flNecromastery_BonusDamage[m_iWeapon] );

                        /* Apply Jinda : Increases damage and set to crit.
                         *
                         * -------------------------------------------------- */
                        if ( m_bJinada_ATTRIBUTE[m_iWeapon] )
                        {
                            if ( m_hTimers[m_iAttacker][m_hJinada_TimerCooldown] == INVALID_HANDLE )
                            {
                                m_hTimers[m_iAttacker][m_hJinada_TimerCooldown] = CreateTimer( m_flJinada_Cooldown[m_iWeapon], m_tJinada, m_iAttacker );

                                m_iType = TF_DMG_CRIT|m_iType;
                                m_flDamage *= m_flJinada_DamageMultiplier[m_iWeapon];

                                EmitSoundToClient( m_iAttacker, SOUND_RADIANCE, _, _, _, _, 1.0 );
                                EmitSoundToClient( m_iVictim, SOUND_RADIANCE, _, _, _, _, 1.0 );
                                if ( m_flJinada_Cooldown[m_iWeapon] != 0.0 ) PrintHintText( m_iAttacker, "Now in cooldown for %.2f seconds", m_flJinada_Cooldown[m_iWeapon] );
                            }
                        }
                         ...
                         *
                         * -------------------------------------------------- */
                        if ( m_bFurySwipes_ATTRIBUTE[m_iWeapon] )
                        {
                            ...
                            if ( m_hTimers[m_iVictim][m_hFurySwipes_TimerDuration] == INVALID_HANDLE && m_iIntegers[m_iVictim][m_iFurySwipe_Stack] < m_iFurySwipes_MaximumStack[m_iWeapon] )
                            {
                                m_iIntegers[m_iVictim][m_iFurySwipe_Stack]++;
                                m_hTimers[m_iVictim][m_hFurySwipes_TimerDuration] = CreateTimer( m_flFurySwipes_Duration[m_iWeapon], m_tFurySwipes, m_iVictim );
                            }

                            new Float:m_flEnrage = 1.0;
                            if ( m_bEnrage_ATTRIBUTE[m_iWeapon] && m_hTimers[m_iAttacker][m_hEnrage_TimerDuration] != INVALID_HANDLE ) m_flEnrage = m_flEnrage_FurySwipeMultiplier[m_iWeapon];

                            m_flDamage += ( ( ( m_iIntegers[m_iVictim][m_iFurySwipe_Stack] * m_flFurySwipes_BonusDamage[m_iWeapon] ) * m_flEnrage ) / ( m_iType & TF_DMG_CRIT ? 3.0 : 1.0 ) );
                        }
                    //-//
                        if ( m_bBash_ATTRIBUTE[m_iWeapon] )
                        {
                            ...
                            new Float:m_flBashChanceReduced = ( m_flBash_Chance[m_iWeapon] * 0.941008 );
                            ...
                            if ( m_flBadPRDChance >= GetRandomFloat( 0.0, 1.0 ) )
                            {
                                ...
                                if ( m_iType & TF_DMG_CRIT || IsCritBoosted( m_iAttacker ) ) m_flDamage += ( m_flBash_BonusDamage[m_iWeapon] / 3.0 );
                                else m_flDamage += m_flBash_BonusDamage[m_iWeapon];

                                if ( m_flBash_Duration[m_iWeapon] != 0.0 ) {
                                    if ( m_flBash_Duration[m_iWeapon] < 0.5 && !HasInvulnerabilityCond( m_iVictim ) ) { // Low stun duration shouldn't pierce Übercharge.
                                        TF2_StunPlayer( m_iVictim, m_flBash_Duration[m_iWeapon], 1.0, TF_STUNFLAG_BONKSTUCK|TF_STUNFLAG_NOSOUNDOREFFECT, m_iAttacker );
                                    }
                                    else if ( m_flBash_Duration[m_iWeapon] >= 0.5 ) TF2_StunPlayer( m_iVictim, m_flBash_Duration[m_iWeapon], 1.0, TF_STUNFLAG_BONKSTUCK|TF_STUNFLAG_NOSOUNDOREFFECT, m_iAttacker );
                                }
                         ...
                         *
                         * -------------------------------------------------- */
                        if ( m_bKillAtHighHealthPointsThreshold_ATTRIBUTE[m_iWeapon] )
                        {
                            if ( GetClientHealth( m_iVictim ) >= ( m_flKillAtHighHealthPointsThreshold_Threshold[m_iWeapon] >= 10.0 ? m_flKillAtHighHealthPointsThreshold_Threshold[m_iWeapon] : TF2_GetClientMaxHealth( m_iVictim ) * m_flKillAtHighHealthPointsThreshold_Threshold[m_iWeapon] ) ) {
                    ...
                    //-//
                        if ( m_bKillAtLowHealthPointsThreshold_ATTRIBUTE[m_iWeapon] )
                        {
                            if ( GetClientHealth( m_iVictim ) <= ( m_flKillAtHighHealthPointsThreshold_Threshold[m_iWeapon] >= 1.0 ? m_flKillAtHighHealthPointsThreshold_Threshold[m_iWeapon] : TF2_GetClientMaxHealth( m_iVictim ) * m_flKillAtHighHealthPointsThreshold_Threshold[m_iWeapon] ) ) {
                                TF2_RemoveCondition( m_iVictim, TFCond_Ubercharged );
                                m_flDamage = 1000000000.0;
                                m_iType = m_iType|TF_DMG_CRIT;
                            }
...
public Action:OnTakeDamageAlive( m_iVictim, &m_iAttacker, &m_iInflictor, &Float:m_flDamage, &m_iType, &m_iWeapon, Float:m_flForce[3], Float:m_flPosition[3], m_iCustom )
{
        ...
        && m_iAttacker != m_iVictim )
    {
        ...
        {
            if ( m_bLifesteal_ATTRIBUTE[m_iWeapon] )
                TF2_HealPlayer( m_iAttacker, m_flDamage * m_flLifesteal_Percentage[m_iWeapon], m_flLifesteal_OverHealBonusCap[m_iWeapon], true );
        //-//
            if ( m_bLifestealOnCrit_ATTRIBUTE[m_iWeapon] )
            {
                if ( m_iType & TF_DMG_CRIT || IsCritBoosted( m_iAttacker ) )
                    TF2_HealPlayer( m_iAttacker, m_flDamage * m_flLifestealOnCrit_Percentage[m_iWeapon], m_flLifestealOnCrit_OverHealBonusCap[m_iWeapon], true );
            }
        //-//
            if ( m_bOverPower_ATTRIBUTE[m_iWeapon] )
            {
        ...
        //-//
            if ( m_bFervor_ATTRIBUTE[m_iWeapon] )
            {
                ...
                if ( m_bFervor_ATTRIBUTE[m_iWeapon3] )
                {
                    ...
                    new Float:m_flValue = m_flFervor_AttackSpeed[m_iWeapon];
                    ...
                    if ( m_bBools[m_iVictim][m_bIsFervor_On] )
                    {
                        if ( m_iIntegers[m_iAttacker][m_iFervor_Stack] >= 1 )
                        {
                            ...
                            if ( m_iIntegers[m_iAttacker][m_iFervor_Stack] > m_iFervor_MaximumStack[m_iWeapon] )
                            {
                                m_iIntegers[m_iAttacker][m_iFervor_Stack] = m_iFervor_MaximumStack[m_iWeapon];
                            }
                            else {
                        ...
                        m_iIntegers[m_iAttacker][m_iFervor_Stack] = 1;
                        TF2Attrib_SetByName( m_iWeapon3, "fire rate bonus", m_flFervor_OldAttackSpeed[m_iWeapon] );
                        m_iOldVictim = m_iVictim;
                    }
                }
            }
        //-//
            if ( m_bEvasionAW2_ATTRIBUTE[m_iWeapon] )
            {
                if ( m_flFloats[m_iAttacker][m_flEvasionChance_AW2] < 1.0 )
                {
                    m_flFloats[m_iAttacker][m_flEvasionChance_AW2] += m_flEvasionAW2_Add[m_iWeapon];
                    if ( m_flFloats[m_iAttacker][m_flEvasionChance_AW2] > 1.0 ) m_flFloats[m_iAttacker][m_flEvasionChance_AW2] = 1.0;
                }
            }
        //-//
            if ( m_bDuel_ATTRIBUTE[m_iWeapon] )
            {
                if ( m_hTimers[m_iAttacker][m_hDuel_TimerCooldown] == INVALID_HANDLE && m_bBools[m_iAttacker][m_bDuel_ReadyForIt] )
                {
                    m_hTimers[m_iAttacker][m_hDuel_TimerCooldown] = CreateTimer( m_flDuel_Cooldown[m_iWeapon], m_tDuel_Cooldown, m_iAttacker );
                    ...
                    if ( m_hTimers[m_iAttacker][m_hDuel_TimerDuration] == INVALID_HANDLE ) {
                        m_hTimers[m_iAttacker][m_hDuel_TimerDuration] = CreateTimer( m_flDuel_Duration[m_iWeapon], m_tDuel_Duration, m_iAttacker );
                    }
        ...
        //-//
            if ( m_bDesolator_ATTRIBUTE[m_iWeapon] )
            {
                m_flFloats[m_iVictim][m_flDesolator_DamageAmplification] = m_flDesolator_DamageAmp[m_iWeapon];
                ...
                if ( m_hTimers[m_iVictim][m_hDesolator_TimerDuration] == INVALID_HANDLE ) {
                    m_hTimers[m_iVictim][m_hDesolator_TimerDuration] = CreateTimer( m_flDesolator_Duration[m_iWeapon], m_tDesolator, m_iVictim );
                }
            }
        }
    }
        ...
        if ( m_iKiller != m_iVictim )
        {
            if ( IsValidClient( m_iKiller ) )
            {
                ...
                if ( HasAttribute( m_iKiller, _, m_bNecromastery_ATTRIBUTE ) )
                {
                    ...
                    if ( act == 0 || m_iWeapon != -1 && m_bHasAttribute[m_iWeapon] && m_bNecromastery_ATTRIBUTE[m_iWeapon] && act == 1 )
                    {
...
public OnEntityDestroyed( m_iEntity )
{
    ...
    if ( m_bHasAttribute[m_iEntity] ) // I use this, so it doesn't call on every ENTITY destroyed, just custom weapons.
    {
        ...
        m_bJinada_ATTRIBUTE[m_iEntity]          = false;
        m_flJinada_Cooldown[m_iEntity]          = 0.0;
        m_flJinada_DamageMultiplier[m_iEntity]  = 0.0;

        m_bTrueStrike_ATTRIBUTE[m_iEntity]      = false;

        m_bFervor_ATTRIBUTE[m_iEntity]          = false;
        m_flFervor_AttackSpeed[m_iEntity]       = 0.0;
        m_flFervor_OldAttackSpeed[m_iEntity]    = 0.0;
        m_iFervor_MaximumStack[m_iEntity]       = 0;

        m_bDuel_ATTRIBUTE[m_iEntity]            = false;
        m_flDuel_Cooldown[m_iEntity]            = 0.0;
        m_flDuel_DamageBonus[m_iEntity]         = 0.0;
        m_flDuel_Duration[m_iEntity]            = 0.0;


        /* On Attack
         * ---------------------------------------------------------------------- */

        m_bStaticField_ATTRIBUTE[m_iEntity]     = false;
        m_flStaticField_DamagePct[m_iEntity]    = 0.0;
        m_flStaticField_Radius[m_iEntity]       = 0.0;


        /* On Kill
         * ---------------------------------------------------------------------- */

        m_bNecromastery_ATTRIBUTE[m_iEntity]        = false;
        m_flNecromastery_BonusDamage[m_iEntity]     = 0.0;
        m_flNecromastery_Removal[m_iEntity]         = 0.0;
        m_iNecromastery_MaximumStack[m_iEntity]     = 0;
        m_iNecromastery_PoA[m_iEntity]  = 0;

        m_bBloodbath_ATTRIBUTE[m_iEntity]           = false;
        m_flBloodbath_Heal[m_iEntity]               = 0.0;
        m_flBloodbath_Radius[m_iEntity]             = 0.0;


        /* On Damage
         * ---------------------------------------------------------------------- */

        m_bKillAtLowHealthPointsThreshold_ATTRIBUTE[m_iEntity]     = false;
        m_flKillAtLowHealthPointsThreshold_Threshold[m_iEntity]     = 0.0;

        m_bKillAtHighHealthPointsThreshold_ATTRIBUTE[m_iEntity]     = false;
        m_flKillAtHighHealthPointsThreshold_Threshold[m_iEntity]    = 0.0;

        m_bFurySwipes_ATTRIBUTE[m_iEntity]                          = false;
        m_flFurySwipes_BonusDamage[m_iEntity]                       = 0.0;
        m_flFurySwipes_Duration[m_iEntity]                          = 0.0;
        m_iFurySwipes_MaximumStack[m_iEntity]                       = 0;

        m_bLifesteal_ATTRIBUTE[m_iEntity]                           = false;
        m_flLifesteal_OverHealBonusCap[m_iEntity]                   = 0.0;
        m_flLifesteal_Percentage[m_iEntity]                         = 0.0;

        m_bLifestealOnCrit_ATTRIBUTE[m_iEntity]                     = false;
        m_flLifestealOnCrit_OverHealBonusCap[m_iEntity]             = 0.0;
        m_flLifestealOnCrit_Percentage[m_iEntity]                   = 0.0;

        m_bDesolator_ATTRIBUTE[m_iEntity]                           = false;
        m_flDesolator_DamageAmp[m_iEntity]                          = 0.0;
        m_flDesolator_Duration[m_iEntity]                           = 0.0;


        /* On Prethink
         * ---------------------------------------------------------------------- */

        m_bRadiance_ATTRIBUTE[m_iEntity]            = false;
        m_flRadiance_Interval[m_iEntity]            = 0.0;
        m_flRadiance_Radius[m_iEntity]              = 0.0;
        m_iRadiance_Damage[m_iEntity]               = 0;

        m_bRadiance_SubAbility_ATTRIBUTE[m_iEntity] = false;
        m_flRadiance_SubAbility_Chance[m_iEntity]   = 0.0;


        /* On Chance
         * ---------------------------------------------------------------------- */

        m_bBash_ATTRIBUTE[m_iEntity]                    = false;
        m_flBash_BonusDamage[m_iEntity]                 = 0.0;
        m_flBash_Chance[m_iEntity]                      = 0.0;
        m_flBash_Duration[m_iEntity]                    = 0.0;

        m_bEvasion_ATTRIBUTE[m_iEntity]                 = false;
        m_flEvasion_Chance[m_iEntity]                   = 0.0;

        m_bEvasionAW2_ATTRIBUTE[m_iEntity]        = false;
        m_flEvasionAW2_Add[m_iEntity]             = 0.0;
        m_flEvasionAW2_Removal[m_iEntity]         = 0.0;
        m_iEvasionAW2_Melee[m_iEntity]            = 0;
        m_iEvasionAW2_PoA[m_iEntity]  = 0;


        /* On Damage Received
         * ---------------------------------------------------------------------- */

        m_bBladeMail_ATTRIBUTE[m_iEntity]       = false;
        m_flBladeMail_Multiplier[m_iEntity]     = 0.0;

        m_bCraggyExterior_ATTRIBUTE[m_iEntity]  = false;
        m_flCraggyExterior_Chance[m_iEntity]    = 0.0;
        m_flCraggyExterior_Duration[m_iEntity]  = 0.0;
        m_flCraggyExterior_Radius[m_iEntity]    = 0.0;
        m_iCraggyExterior_Damage[m_iEntity]     = 0;

        m_bDispersion_ATTRIBUTE[m_iEntity]      = false;
        m_flDispersion_MaxDamage[m_iEntity]     = 0.0; 
        m_flDispersion_MaxRadius[m_iEntity]     = 0.0;
        m_flDispersion_MinRadius[m_iEntity]     = 0.0;

        m_bReturn_ATTRIBUTE[m_iEntity]          = false;
        m_flReturn_Damage[m_iEntity]            = 0.0; 
        m_iReturn_BaseDamage[m_iEntity]         = 0; 

        m_bBlockDamage_ATTRIBUTE[m_iEntity]     = false;
        m_flBlockDamage_Block[m_iEntity]        = 0.0; 
        m_flBlockDamage_Chance[m_iEntity]       = 0.0; 


        /* To Activate
         * ---------------------------------------------------------------------- */

        m_bEnchantTotem_ATTRIBUTE[m_iEntity]            = false;
        m_flEnchantTotem_BonusDamage[m_iEntity]         = 0.0;
        m_flEnchantTotem_Cooldown[m_iEntity]            = 0.0;
        m_flEnchantTotem_Duration[m_iEntity]            = 0.0;

        m_bOverPower_ATTRIBUTE[m_iEntity]               = false;
        m_flOverPower_AttackSpeed[m_iEntity]            = 0.0;
        m_flOverPower_Cooldown[m_iEntity]               = 0.0;
        m_flOverPower_Duration[m_iEntity]               = 0.0;
        m_flOverPower_OldAttackSpeed[m_iEntity]         = 0.0;
        m_iOverPower_Hit[m_iEntity]                     = 0;

        m_bEnrage_ATTRIBUTE[m_iEntity]                  = false;
        m_flEnrage_Cooldown[m_iEntity]                  = 0.0;
        m_flEnrage_Duration[m_iEntity]                  = 0.0;
        m_flEnrage_FurySwipeMultiplier[m_iEntity]       = 0.0;
        m_flEnrage_Resistance[m_iEntity]                = 0.0;

        m_bInnerVitality_ATTRIBUTE[m_iEntity]           = false;
        m_flInnerVitality_BaseRegen[m_iEntity]          = 0.0;
        m_flInnerVitality_Cooldown[m_iEntity]           = 0.0;
        m_flInnerVitality_Duration[m_iEntity]           = 0.0;
        m_flInnerVitality_HealthHealAbove[m_iEntity]    = 0.0;
        m_flInnerVitality_HealthHealBelow[m_iEntity]    = 0.0;
        m_flInnerVitality_HealthThreshold[m_iEntity]    = 0.0;


        /* On Death
         * ---------------------------------------------------------------------- */

        m_bLastWill_ATTRIBUTE[m_iEntity]    = false;
        m_iLastWill_Damage[m_iEntity]       = 0;
    }
}
// -
// --
